...
def content() -> None:
    ui.label('Instructional Materials').classes('text-h2 font-bold text-grey-8')
    with ui.row().classes("w-full no-wrap"):
        ui.label("MATERIALS").classes(
                    "text-h2 w-screen no-wrap py-4 text-black font-bold text-xl "
                    "justify-center items-center"
                    )
    with ui.row().classes("w-full no-wrap"):
        ui.label("ABACUS").classes(
                "text-h3 w-screen no-wrap font-bold text-black text-xl justify-center "
                "items-center"
                )
    ...
    with ui.row().classes("w-full no-wrap"):
        ui.label("SCREENREADER").classes(
                "w-screen no-wrap font-bold text-black text-xl justify-center "
                "items-center"
                )
    with ui.row().classes("w-full no-wrap py-4"):
        ui.link(
    ...
    with ui.row().classes("w-full no-wrap"):
        ui.label("DATASHEETS").classes(
                "text-h3 w-screen no-wrap content-center font-bold text-black text-xl"
                )
    with ui.row().classes("w-full no-wrap py-4"):
        ui.link(
    ...
    with ui.row().classes("w-full no-wrap"):
        ui.label("ASSESSMENT FORMS").classes(
                "text-h3 w-screen no-wrap py-4 font-bold text-black text-xl "
                "justify-center items-center"
                )
    with ui.row().classes("w-full no-wrap"):
        ui.link(
