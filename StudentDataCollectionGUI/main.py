...
class dataPanel(wx.Panel):
  def __init__(self, parent):
    ...
    self.trial011 = wx.TextCtrl(self, -1, "", pos=( 130, 80), size=(300, 20))
    wx.StaticText(self, -1, "Trial 2", pos=(500, 110))
    self.trial021 = wx.TextCtrl(self, -1, "", pos=( 130, 110), size=(300, 20))
    wx.StaticText(self, -1, "Trial 3", pos=(500, 140))
    self.trial031 = wx.TextCtrl(self, -1, "", pos=( 130, 140), size=(300, 20))
    wx.StaticText(self, -1, "Trial 4", pos=(500, 170))
    self.trial041 = wx.TextCtrl(self, -1, "", pos=( 130, 170), size=(300, 20))
    wx.StaticText(self, -1, "Trial 5", pos=(500, 200))
    self.trial051 = wx.TextCtrl(self, -1, "", pos=( 130, 200), size=(300, 20))
    wx.StaticText(self, -1, "Trial 6", pos=(500, 230))
    self.trial061 = wx.TextCtrl(self, -1, "", pos=( 130, 230), size=(300, 20))
    wx.StaticText(self, -1, "Trial 7", pos=(500, 260))
    self.trial071 = wx.TextCtrl(self, -1, "", pos=( 130, 260), size=(300, 20))
    wx.StaticText(self, -1, "Trial 8", pos=(500, 290))
    self.trial081 = wx.TextCtrl(self, -1, "", pos=( 130, 290), size=(300, 20))
    wx.StaticText(self, -1, "Trial 9", pos=(500, 320))
    self.trial091 = wx.TextCtrl(self, -1, "", pos=( 130, 320), size=(300, 20))
    wx.StaticText(self, -1, "Trial 10", pos=(500, 350))
    self.trial101 = wx.TextCtrl(self, -1, "", pos=( 130, 350), size=(300, 20))
    wx.StaticText(self, -1, "Trial 11", pos=(500, 380))
    self.trial111 = wx.TextCtrl(self, -1, "", pos=( 130, 380), size=(300, 20))
    wx.StaticText(self, -1, "Anecdotal Notes", pos=(500, 410))
    self.notes1 = wx.TextCtrl(self, -1, "", pos=( 130, 440), size=(300, 375),      style=wx.TE_MULTILINE)
  ...
  self.studentname1.GetSelection())
    ...
    self.dataPlot = wx.StaticBitmap(self, -1, wx.Bitmap(
      ...
      wx.BITMAP_TYPE_ANY),   pos=(975, 400), size=(500, 400))
...
class braillePanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.trial11 = wx.TextCtrl(self, -1, "", pos=(130, 80), size=(300, 20))
        wx.StaticText(self, -1, "1.2 Track Top to Bottom",pos=(500, 110))
        self.trial12 = wx.TextCtrl(self, -1, "", pos=(130, 110), size=(300, 20))
        wx.StaticText(self, -1, "1.3 Discriminate Shapes",pos=(500, 140))
        self.trial13 = wx.TextCtrl(self, -1, "", pos=(130, 140), size=(300, 20))
        wx.StaticText(self, -1, "1.4 Discriminate Braille Characters",pos=(500, 170))
        self.trial14 = wx.TextCtrl(self, -1, "", pos=(130, 170), size=(300, 20))
        wx.StaticText(self, -1, "2.1 G C L", pos=(500, 200))
        self.trial21 = wx.TextCtrl(self, -1, "", pos=(130, 200), size=(300, 20))
        wx.StaticText(self, -1, "2.2 D Y", pos=(500, 230))
        self.trial22 = wx.TextCtrl(self, -1, "", pos=(130, 230), size=(300, 20))
        wx.StaticText(self, -1, "2.3 A B", pos=(500, 260))
        self.trial23 = wx.TextCtrl(self, -1, "", pos=(130, 260), size=(300, 20))
        wx.StaticText(self, -1, "2.4 S", pos=(500, 290))
        self.trial24 = wx.TextCtrl(self, -1, "", pos=(130, 290), size=(300, 20))
        wx.StaticText(self, -1, "2.5 W", pos=(500, 80))
        self.trial25 = wx.TextCtrl(self, -1, "", pos=(130, 80), size=(300, 20))
        wx.StaticText(self, -1, "2.6 P O", pos=(500, 110))
        self.trial26 = wx.TextCtrl(self, -1, "", pos=(130, 110), size=(300, 20))
        wx.StaticText(self, -1, "2.7 K", pos=(500, 140))
        self.trial27 = wx.TextCtrl(self, -1, "", pos=(130, 140), size=(300, 20))
        wx.StaticText(self, -1, "2.8 R", pos=(500, 170))
        self.trial28 = wx.TextCtrl(self, -1, "", pos=(130, 170), size=(300, 20))
        wx.StaticText(self, -1, "2.9 M E", pos=(500, 200))
        self.trial29 = wx.TextCtrl(self, -1, "", pos=(130, 200), size=(300, 20))
        wx.StaticText(self, -1, "2.10 H", pos=(500, 230))
        self.trial210 = wx.TextCtrl(self, -1, "", pos=(130, 230), size=(300, 20))
        wx.StaticText(self, -1, "2.11 N X", pos=(500, 260))
        self.trial211 = wx.TextCtrl(self, -1, "", pos=(130, 260), size=(300, 20))
        wx.StaticText(self, -1, "2.12 Z F", pos=(500, 290))
        self.trial212 = wx.TextCtrl(self, -1, "", pos=(130, 290), size=(300, 20))
        wx.StaticText(self, -1, "2.13 U T", pos=(500, 80))
        self.trial213 = wx.TextCtrl(self, -1, "", pos=(130, 80), size=(300, 20))
        wx.StaticText(self, -1, "2.14 Q I", pos=(500, 110))
        self.trial214 = wx.TextCtrl(self, -1, "", pos=( 130, 110), size=(300, 20))
        wx.StaticText(self, -1, "2.15 V J", pos=(500, 140))
        self.trial215 = wx.TextCtrl(self, -1, "", pos=( 130, 140), size=(300, 20))
        wx.StaticText(self, -1, "3.1 Alphabetic Wordsigns",pos=(500, 170))
        self.trial31 = wx.TextCtrl(self, -1, "", pos=( 130, 170), size=(300, 20))
        wx.StaticText(self, -1, "3.2 Braille Numbers", pos=(500, 200))
        self.trial32 = wx.TextCtrl(self, -1, "", pos=( 130, 200), size=(300, 20))
        wx.StaticText(self, -1, "3.3 Punctuation", pos=(500, 230))
        self.trial33 = wx.TextCtrl(self, -1, "", pos=( 130, 230), size=(300, 20))
        wx.StaticText(self, -1,"3.4 Strong Contractions - AND OF FOR WITH THE",pos=(500, 260))
        self.trial34 = wx.TextCtrl(self, -1, "", pos=( 130, 260), size=(300, 20))
        wx.StaticText(self, -1,"3.5 Strong Groupsigns - CH GH SH TH WH ED ER OU OW ST AR ING",pos=(500, 290))
        self.trial35 = wx.TextCtrl(self, -1, "", pos=( 130, 290), size=(300, 20))
        wx.StaticText(self, -1,"3.6 Strong Wordsigns - CH SH TH WH OU ST",pos=(500, 80))
        self.trial36 = wx.TextCtrl(self, -1, "", pos=( 130, 80), size=(300, 20))
        wx.StaticText(self, -1, "3.7 Lower Groupsigns - BE CON DIS",pos=(500, 110))
        self.trial37 = wx.TextCtrl(self, -1, "", pos=( 130, 110), size=(300, 20))
        wx.StaticText(self, -1, "3.8 Lower Groupsigns - EA BB CC FF GG",pos=(500, 140))
        self.trial38 = wx.TextCtrl(self, -1, "", pos=( 130, 140), size=(300, 20))
        wx.StaticText(self, -1, "3.9 Lower Group/Wordsigns - EN IN",pos=(500, 170))
        self.trial39 = wx.TextCtrl(self, -1, "", pos=( 130, 170), size=(300, 20))
        wx.StaticText(self, -1,"3.10 Lower Wordsigns - BE HIS WAS WERE",pos=(500, 200))
        self.trial310 = wx.TextCtrl(self, -1, "", pos=( 130, 200), size=(300, 20))
        wx.StaticText(self, -1, "3.11 Dot 5 Contractions",pos=(500, 230))
        self.trial311 = wx.TextCtrl(self, -1, "", pos=( 130, 230), size=(300, 20))
        wx.StaticText(self, -1, "3.12 Dot 45 Contractions",pos=(500, 260))
        self.trial312 = wx.TextCtrl(self, -1, "", pos=( 130, 260), size=(300, 20))
        wx.StaticText(self, -1, "3.13 Dot 456 Contractions",pos=(500, 290))
        self.trial313 = wx.TextCtrl(self, -1, "", pos=( 130, 290), size=(300, 20))
        wx.StaticText(self, -1, "3.14 Final Letter Groupsigns",pos=(500, 80))
        self.trial314 = wx.TextCtrl(self, -1, "", pos=( 130, 80), size=(300, 20))
        wx.StaticText(self, -1, "3.15 Shortform Words", pos=(500, 110))
        self.trial315 = wx.TextCtrl(self, -1, "", pos=( 130, 110), size=(300, 20))
        wx.StaticText(self, -1, "4.1 Grade 1 Indicators",pos=(500, 140))
        self.trial41 = wx.TextCtrl(self, -1, "", pos=( 130, 140), size=(300, 20))
        wx.StaticText(self, -1, "4.2 Capitals Indicators",pos=(500, 170))
        self.trial42 = wx.TextCtrl(self, -1, "", pos=( 130, 170), size=(300, 20))
        wx.StaticText(self, -1, "4.3 Numeric Mode and Spatial Math",pos=(500, 200))
        self.trial43 = wx.TextCtrl(self, -1, "", pos=( 130, 200), size=(300, 20))
        wx.StaticText(self, -1,"4.4 Typeform Indicators - ITALIC, SCRIPT, UNDERLINE, SCRIPT",pos=(500, 230))
        self.trial44 = wx.TextCtrl(self, -1, "", pos=( 130, 230), size=(300, 20))
        wx.StaticText(self, -1, "5.1 Page Numbering", pos=(500, 260))
        self.trial51 = wx.TextCtrl(self, -1, "", pos=( 130, 260), size=(300, 20))
        wx.StaticText(self, -1, "5.2 Headings", pos=(500, 290))
        self.trial52 = wx.TextCtrl(self, -1, "", pos=( 130, 290), size=(300, 20))
        wx.StaticText(self, -1, "5.3 Lists", pos=(500, 80))
        self.trial53 = wx.TextCtrl(self, -1, "", pos=( 130, 80), size=(300, 20))
        wx.StaticText(self, -1, "5.4 Poetry / Drama", pos=(500, 110))
        self.trial54 = wx.TextCtrl(self, -1, "", pos=( 130, 110), size=(300, 20))
        wx.StaticText(self, -1, "6.1 Operation and Comparison Signs",pos=(500, 140))
        self.trial61 = wx.TextCtrl(self, -1, "", pos=( 130, 140), size=(300, 20))
        wx.StaticText(self, -1, "6.2 Grade 1 Mode", pos=(500, 170))
        self.trial62 = wx.TextCtrl(self, -1, "", pos=( 130, 170), size=(300, 20))
        wx.StaticText(self, -1, "6.3 Special Print Symbols",pos=(500, 200))
        self.trial63 = wx.TextCtrl(self, -1, "", pos=( 130, 200), size=(300, 20))
        wx.StaticText(self, -1, "6.4 Omission Marks", pos=(500, 230))
        self.trial64 = wx.TextCtrl(self, -1, "", pos=( 130, 230), size=(300, 20))
        wx.StaticText(self, -1, "6.5 Shape Indicators", pos=(500, 260))
        self.trial65 = wx.TextCtrl(self, -1, "", pos=( 130, 260), size=(300, 20))
        wx.StaticText(self, -1, "6.6 Roman Numerals", pos=(500, 290))
        self.trial66 = wx.TextCtrl(self, -1, "", pos=( 130, 290), size=(300, 20))
        wx.StaticText(self, -1, "6.7 Fractions", pos=(500, 80))
        self.trial67 = wx.TextCtrl(self, -1, "", pos=( 130, 80), size=(300, 20))
        wx.StaticText(self, -1, "7.1 Grade 1 Mode and algebra",pos=(500, 110))
        self.trial71 = wx.TextCtrl(self, -1, "", pos=( 130, 110), size=(300, 20))
        wx.StaticText(self, -1, "7.2 Grade 1 Mode and Fractions",pos=(500, 140))
        self.trial72 = wx.TextCtrl(self, -1, "", pos=( 130, 140), size=(300, 20))
        wx.StaticText(self, -1,"7.3 Advanced Operation and COmparison Signs",pos=(500, 170))
        self.trial73 = wx.TextCtrl(self, -1, "", pos=( 130, 170), size=(300, 20))
        wx.StaticText(self, -1, "7.4 Indices", pos=(500, 200))
        self.trial74 = wx.TextCtrl(self, -1, "", pos=( 130, 200), size=(300, 20))
        wx.StaticText(self, -1, "7.5 Roots and Radicals",pos=(500, 230))
        self.trial75 = wx.TextCtrl(self, -1, "", pos=( 130, 230), size=(300, 20))
        wx.StaticText(self, -1, "7.6 Miscellaneous Shape Indicators",pos=(500, 260))
        self.trial76 = wx.TextCtrl(self, -1, "", pos=( 130, 260), size=(300, 20))
        wx.StaticText(self, -1, "7.7 Functions", pos=(500, 290))
        self.trial77 = wx.TextCtrl(self, -1, "", pos=( 130, 290), size=(300, 20))
        wx.StaticText(self, -1, "7.8 Greek Letters", pos=(500, 80))
        self.trial78 = wx.TextCtrl(self, -1, "", pos=( 130, 80), size=(300, 20))
        wx.StaticText(self, -1, "8.1 Functions", pos=(500, 110))
        self.trial81 = wx.TextCtrl(self, -1, "", pos=( 130, 110), size=(300, 20))
        wx.StaticText(self, -1, "8.2 Modifiers, Bars, and Dots",pos=(500, 140))
        self.trial82 = wx.TextCtrl(self, -1, "", pos=( 130, 140), size=(300, 20))
        wx.StaticText(self, -1, "8.3 Modifiers, Arrows, and Limits",pos=(500, 170))
        self.trial83 = wx.TextCtrl(self, -1, "", pos=( 130, 170), size=(300, 20))
        wx.StaticText(self, -1, "8.4 Probability", pos=(500, 200))
        self.trial84 = wx.TextCtrl(self, -1, "", pos=( 130, 200), size=(300, 20))
        wx.StaticText(self, -1, "8.5 Calculus: Differentiation",pos=(500, 230))
        self.trial85 = wx.TextCtrl(self, -1, "", pos=( 130, 230), size=(300, 20))
        wx.StaticText(self, -1, "8.6 Calculus: Integration",pos=(500, 260))
        self.trial86 = wx.TextCtrl(self, -1, "", pos=( 130, 260), size=(300, 20))
        wx.StaticText(self, -1, "8.7 Vertical Bars", pos=(500, 290))
        self.trial87 = wx.TextCtrl(self, -1, "", pos=( 130, 290), size=(300, 20))
    ...
    def data_entry():
        c.execute(   "INSERT INTO studentdata (studentname, date, task, lesson, session, trial01, trial02, trial03, trial04, trial05, trial06, trial07, trial08, trial09, trial10, trial11, median, notes) VALUES (?,?,?,?, ?, ?, ?, ?,?, ?, ?, ?, ?,?, ?, ?, ?, ?)",   (studentname, dateNow, task, lesson, session, trial01,    trial02, trial03, trial04, trial05, trial06, trial07,    trial08, trial09, trial10, trial11, trialmedian, notes))
        conn.commit()
        self.dial = wx.MessageDialog(None, 'Saved successfully!','Info', wx.OK)
        self.dial.ShowModal()
#        else:
...
# df_noisy = df + noise
# print(
#   df_noisy) # df_noisy is used for all plotting. Replace df_noisy with df in all fig.add_trace below for unadjusted raw data
#
# ###################
# # Line Plots
# ###################
...
# )
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P1.1"], mode="lines+markers",
#  name="Track left to right", legendgroup="Phase 1",
#  legendgrouptitle_text="Phase 1"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P1.2"], mode="lines+markers",
#  name="Track top to bottom", legendgroup="Phase 1",
#  legendgrouptitle_text="Phase 1"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P1.3"], mode="lines+markers",
#  name="Discriminate shapes", legendgroup="Phase 1",
#  legendgrouptitle_text="Phase 1"), row=2, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P1.4"], mode="lines+markers",
#  name="Discriminate braille characters", legendgroup="Phase 1",
#  legendgrouptitle_text="Phase 1"), row=2, col=1)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.1"], mode="lines+markers+text",
#  name="Alphabet", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=True), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.1"].iloc[[-1]],
...
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.2"], mode="lines+markers+text",
#  name="D Y", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.2"].iloc[[-1]],
# mode="text", text=[" D Y"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.3"], mode="lines+markers+text",
#  name="A B", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.3"].iloc[[-1]],
# mode="text", text=[" A B"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.4"], mode="lines+markers+text",
#  name="S", legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
#  showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.4"].iloc[[-1]],
# mode="text", text=[" S"], textposition="middle right",
# legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
# showlegend=False), row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.5"], mode="lines+markers+text",
#  name="W", legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
#  showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.5"].iloc[[-1]],
# mode="text", text=[" W"], textposition="middle right",
# legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
# showlegend=False), row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.6"], mode="lines+markers+text",
#  name="P O", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.6"].iloc[[-1]],
# mode="text", text=[" P O"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.7"], mode="lines+markers+text",
#  name="K", legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
#  showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.7"].iloc[[-1]],
# mode="text", text=[" K"], textposition="middle right",
# legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
# showlegend=False), row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.8"], mode="lines+markers+text",
#  name="R", legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
#  showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.8"].iloc[[-1]],
# mode="text", text=[" R"], textposition="middle right",
# legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
# showlegend=False), row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.9"], mode="lines+markers+text",
#  name="M E", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.9"].iloc[[-1]],
# mode="text", text=[" M E"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.10"], mode="lines+markers+text",
#  name="H", legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
#  showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.10"].iloc[[-1]],
# mode="text", text=[" H"], textposition="middle right",
# legendgroup="Phase 2", legendgrouptitle_text="Phase 2",
# showlegend=False), row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.11"], mode="lines+markers+text",
#  name="N X", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.11"].iloc[[-1]],
# mode="text", text=[" N X"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.12"], mode="lines+markers+text",
#  name="Z F", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.12"].iloc[[-1]],
# mode="text", text=[" Z F"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.13"], mode="lines+markers+text",
#  name="U T", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.13"].iloc[[-1]],
# mode="text", text=[" U T"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.14"], mode="lines+markers+text",
#  name="Q I", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.14"].iloc[[-1]],
# mode="text", text=[" Q I"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P2.15"], mode="lines+markers+text",
#  name="V J ", legendgroup="Phase 2",
#  legendgrouptitle_text="Phase 2", showlegend=False), row=1, col=2)
# fig.add_trace(go.Scatter(x=df_noisy.index[[-1]], y=df_noisy["P2.15"].iloc[[-1]],
# mode="text", text=[" V J"],
# textposition="middle right", legendgroup="Phase 2",
# legendgrouptitle_text="Phase 2", showlegend=False),
#  row=1, col=2)
...
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.1"], mode="lines+markers",
#  name="Alphabetic Wordsigns", legendgroup="Phase 3a",
#  legendgrouptitle_text="Phase 3a"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.2"], mode="lines+markers",
#  name="Braille Numbers", legendgroup="Phase 3a",
#  legendgrouptitle_text="Phase 3a"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.3"], mode="lines+markers",
#  name="Punctuation", legendgroup="Phase 3a",
#  legendgrouptitle_text="Phase 3a"), row=3, col=1)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.4"], mode="lines+markers",
#  name="Strong Contractions <br>(AND OF FOR WITH THE)",
#  legendgroup="Phase 3b", legendgrouptitle_text="Phase 3b"), row=3,
#   col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.5"], mode="lines+markers",
#  name="Strong Groupsigns <br>(CH GH SH TH WH ED ER OU OW ST AR ING)",
#  legendgroup="Phase 3b", legendgrouptitle_text="Phase 3b"), row=3,
#   col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.6"], mode="lines+markers",
#  name="Strong Wordsigns <br>(CH SH TH WH OU ST)",
#  legendgroup="Phase 3b", legendgrouptitle_text="Phase 3b"), row=3,
#   col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.7"], mode="lines+markers",
#  name="Lower Groupsigns <br>(BE CON DIS)", legendgroup="Phase 3c",
#  legendgrouptitle_text="Phase 3c"), row=5, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.8"], mode="lines+markers",
#  name="Lower Groupsigns <br>(EA BB CC FF GG)",
#  legendgroup="Phase 3c", legendgrouptitle_text="Phase 3c"), row=5,
#   col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.9"], mode="lines+markers",
#  name="Lower Groupsigns/Wordsigns <br>(EN IN)",
#  legendgroup="Phase 3c", legendgrouptitle_text="Phase 3c"), row=5,
#   col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.10"], mode="lines+markers",
#  name="Lower Wordsigns <br>(BE HIS WAS WERE)",
#  legendgroup="Phase 3c", legendgrouptitle_text="Phase 3c"), row=5,
#   col=1)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.11"], mode="lines+markers",
#  name="Dot 5 Contractions", legendgroup="Phase 3d",
#  legendgrouptitle_text="Phase 3d"), row=5, col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.12"], mode="lines+markers",
#  name="Dot 45 Contractions", legendgroup="Phase 3d",
#  legendgrouptitle_text="Phase 3d"), row=5, col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.13"], mode="lines+markers",
#  name="Dot 456 Contractions", legendgroup="Phase 3d",
#  legendgrouptitle_text="Phase 3d"), row=5, col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.14"], mode="lines+markers",
#  name="Final Letter Groupsigns", legendgroup="Phase 3d",
#  legendgrouptitle_text="Phase 3d"), row=5, col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P3.15"], mode="lines+markers",
#  name="Shortform Words", legendgroup="Phase 3d",
#  legendgrouptitle_text="Phase 3d"), row=5, col=2)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P4.1"], mode="lines+markers",
#  name="Grade 1 Indicators", legendgroup="Phase 4",
#  legendgrouptitle_text="Phase 4"), row=7, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P4.2"], mode="lines+markers",
#  name="Capitals Indicators", legendgroup="Phase 4",
#  legendgrouptitle_text="Phase 4"), row=7, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P4.3"], mode="lines+markers",
#  name="Numeric Mode and Spatial math", legendgroup="Phase 4",
#  legendgrouptitle_text="Phase 4"), row=7, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P4.4"], mode="lines+markers",
#  name="Typeform Indicators <br>(ITALIC, SCRIPT, UNDERLINE, BOLDFACE)",
#  legendgroup="Phase 4", legendgrouptitle_text="Phase 4"), row=7,
#   col=1)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P5.1"], mode="lines+markers",
#  name="Page Numbering", legendgroup="Phase 5",
#  legendgrouptitle_text="Phase 5"), row=7, col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P5.2"], mode="lines+markers",
#  name="Headings", legendgroup="Phase 5",
#  legendgrouptitle_text="Phase 5"), row=7, col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P5.3"], mode="lines+markers",
#  name="Lists", legendgroup="Phase 5",
#  legendgrouptitle_text="Phase 5"), row=7, col=2)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P5.4"], mode="lines+markers",
...
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P6.1"], mode="lines+markers",
#  name=" Operation and Comparison Signs", legendgroup="Phase 6",
#  legendgrouptitle_text="Phase 6"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P6.2"], mode="lines+markers",
#  name="Grade 1 Mode", legendgroup="Phase 6",
#  legendgrouptitle_text="Phase 6"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P6.3"], mode="lines+markers",
#  name="Special Print Symbols", legendgroup="Phase 6",
#  legendgrouptitle_text="Phase 6"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P6.4"], mode="lines+markers",
#  name="Omission Marks", legendgroup="Phase 6",
#  legendgrouptitle_text="Phase 6"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P6.5"], mode="lines+markers",
#  name="Shape Indicators", legendgroup="Phase 6",
#  legendgrouptitle_text="Phase 6"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P6.6"], mode="lines+markers",
#  name="Roman Numerals", legendgroup="Phase 6",
#  legendgrouptitle_text="Phase 6"), row=1, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P6.7"], mode="lines+markers",
#  name="Fractions", legendgroup="Phase 6",
#  legendgrouptitle_text="Phase 6"), row=1, col=1)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.1"], mode="lines+markers",
#  name="Grade 1 Mode and Algebra", legendgroup="Phase 7",
#  legendgrouptitle_text="Phase 7"), row=2, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.2"], mode="lines+markers",
#  name="Grade 1 Mode and Fractions", legendgroup="Phase 7",
#  legendgrouptitle_text="Phase 7"), row=2, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.3"], mode="lines+markers",
#  name="Advanced Operation and Comparison Signs",
#  legendgroup="Phase 7", legendgrouptitle_text="Phase 7"), row=2,
#   col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.4"], mode="lines+markers",
#  name="Indices", legendgroup="Phase 7",
#  legendgrouptitle_text="Phase 7"), row=2, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.5"], mode="lines+markers",
#  name="Roots and Radicals", legendgroup="Phase 7",
#  legendgrouptitle_text="Phase 7"), row=2, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.6"], mode="lines+markers",
#  name="Miscellaneous Shape Indicators", legendgroup="Phase 7",
#  legendgrouptitle_text="Phase 7"), row=2, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.7"], mode="lines+markers",
#  name="Functions", legendgroup="Phase 7",
#  legendgrouptitle_text="Phase 7"), row=2, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P7.8"], mode="lines+markers",
#  name="Greek letters", legendgroup="Phase 7",
#  legendgrouptitle_text="Phase 7"), row=2, col=1)
#
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P8.1"], mode="lines+markers",
#  name="Functions", legendgroup="Phase 8",
#  legendgrouptitle_text="Phase 8"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P8.2"], mode="lines+markers",
#  name="Modifiers, Bars, and Dots", legendgroup="Phase 8",
#  legendgrouptitle_text="Phase 8"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P8.3"], mode="lines+markers",
#  name="Modifiers, Arrows, and Limits", legendgroup="Phase 8",
#  legendgrouptitle_text="Phase 8"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P8.4"], mode="lines+markers",
#  name="Probability", legendgroup="Phase 8",
#  legendgrouptitle_text="Phase 8"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P8.5"], mode="lines+markers",
#  name="Calculus: Differentiation", legendgroup="Phase 8",
#  legendgrouptitle_text="Phase 8"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P8.6"], mode="lines+markers",
#  name="Calculus: Integration", legendgroup="Phase 8",
#  legendgrouptitle_text="Phase 8"), row=3, col=1)
# fig.add_trace(
#   go.Scatter(x=df_noisy.index, y=df_noisy["P8.7"], mode="lines+markers",
#  name="Vertical Bars", legendgroup="Phase 8",
#  legendgrouptitle_text="Phase 8"), row=3, col=1)
#
# fig.update_xaxes(rangebreaks=[dict(
#   values=["2021-12-16", "2021-12-17", "2021-12-18", "2021-12-19",
...
#    legend=dict(font=dict(size=10)))
# fig.write_html(
#   "C:\\Users\\hunsa\\Downloads\\TechScreenReader_DSD\\DSDSTUDENTS\\PMPLOTS\\UEBTechnicalSkillsProgression.html")
# fig.show()
#
