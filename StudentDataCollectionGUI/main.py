...
class braillePanel(wx.Panel):
    def __init__(self, parent):
        ...
        wx.StaticText(self, -1, "1.1 Track Left to Right",
                      pos=(500, 80))
        self.trial11 = wx.TextCtrl(self, -1, "", pos=(550, 80),
                                   size=(300, 20))
        wx.StaticText(self, -1, "1.2 Track Top to Bottom",
                      pos=(500, 110))
        self.trial12 = wx.TextCtrl(self, -1, "", pos=(550, 110),
                                   size=(300, 20))
        wx.StaticText(self, -1, "1.3 Discriminate Shapes",
                      pos=(500, 140))
        ...
        self.trial215 = wx.TextCtrl(self, -1, "", pos=(550, 140),
                                    size=(300, 20))
        wx.StaticText(self, -1, "3.1 Alphabetic Wordsigns",
                      pos=(500, 170))
        ...
        self.trial310 = wx.TextCtrl(self, -1, "", pos=(550, 200),
                                    size=(300, 20))
        wx.StaticText(self, -1, "3.11 Dot 5 Contractions",
                      pos=(500, 230))
        self.trial311 = wx.TextCtrl(self, -1, "", pos=(550, 230),
                                    size=(300, 20))
        wx.StaticText(self, -1, "3.12 Dot 45 Contractions",
                      pos=(500, 260))
        self.trial312 = wx.TextCtrl(self, -1, "", pos=(550, 260),
                                    size=(300, 20))
        wx.StaticText(self, -1, "3.13 Dot 456 Contractions",
                      pos=(500, 290))
        self.trial313 = wx.TextCtrl(self, -1, "", pos=(550, 290),
                                    size=(300, 20))
        wx.StaticText(self, -1, "3.14 Final Letter Groupsigns",
                      pos=(500, 80))
        ...
        self.trial315 = wx.TextCtrl(self, -1, "", pos=(550, 110),
                                    size=(300, 20))
        wx.StaticText(self, -1, "4.1 Grade 1 Indicators",
                      pos=(500, 140))
        self.trial41 = wx.TextCtrl(self, -1, "", pos=(550, 140),
                                   size=(300, 20))
        wx.StaticText(self, -1, "4.2 Capitals Indicators",
                      pos=(500, 170))
        ...
        self.trial62 = wx.TextCtrl(self, -1, "", pos=(550, 170),
                                   size=(300, 20))
        wx.StaticText(self, -1, "6.3 Special Print Symbols",
                      pos=(500, 200))
        ...
        self.trial67 = wx.TextCtrl(self, -1, "", pos=(550, 80),
                                   size=(300, 20))
        wx.StaticText(self, -1, "7.1 Grade 1 Mode and algebra",
                      pos=(500, 110))
        ...
        self.trial74 = wx.TextCtrl(self, -1, "", pos=(550, 200),
                                   size=(300, 20))
        wx.StaticText(self, -1, "7.5 Roots and Radicals",
                      pos=(500, 230))
        ...
        self.trial85 = wx.TextCtrl(self, -1, "", pos=(550, 230),
                                   size=(300, 20))
        wx.StaticText(self, -1, "8.6 Calculus: Integration",
                      pos=(500, 260))
