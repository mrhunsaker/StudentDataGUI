        ...
        with theme.frame("- TECHNOLOGY SKILLS -"):
            ...
            with ui.tab_panels(tabs, value="DATA INPUT"):
                with ui.tab_panel("DATA INPUT"):
                    ui.label("DIGITAL LITERACY").classes("text-h4 text-grey-8").style(
                    ...
                    def save(event):
                        ...
                        studentdatabasename = (
                            f"digitalliteracy{studentname.title()}{datenow}"
                        )
                ...
                def graph(event):
                    ...
                    df_sql = pd.read_sql_query(
                        "SELECT * FROM DIGITALLITERACYPROGRESS", conn
                    )
                    ...
                    fig.add_trace(
                        go.Scatter(
                            ...
                            y=df_noisy["P1_6"],
                            mode="lines+markers",
                            name="Keyboarding<br> (Use proper posture and ergonomics,<br> Locate and use letter and numbers keys with left and right hand placement,<br> Locate and use correct finger, hand for space bar,return/enter and shift key,"
                            "<br> Gain proficiency and speed in touch typing)",
                            legendgroup="Phase 1",
                            legendgrouptitle_text="Phase 1",
                            showlegend=False,
                            hovertemplate="  %{y:.1f} ",
                    ...
                    fig.add_trace(
                        go.Scatter(
                            ...
                            y=df_noisy["P11_3"],
                            mode="lines+markers",
                            name="Explain and demonstrate how specialized technology tools can be used for problem solving, decision making, and creativity in all subject areas (e.g., simulation software, environmental probes, computer aided design, "
                ...
                def create_ui() -> None:
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial11.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                        )
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        'font-style:normal, font-family: "Atkinson Hyperlegible"'
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial12.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial13.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial14.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial15.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial16.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial21.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial22.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial23.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial24.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial25.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial26.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial31.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial32.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial33.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial34.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial35.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial41.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial42.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial43.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial44.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial45.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.input().props(
                            'aria-label="Copyright and Plagiarism"'
                        ).classes("sr-only")
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ):
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial51.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial52.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial53.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial54.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial55.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial56.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial57.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial61.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial62.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial63.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial64.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial65.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial71.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial72.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial73.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial74.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial75.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial81.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial82.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial83.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial84.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial85.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial86.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial91.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial92.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial93.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial94.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial95.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial101.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial102.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial103.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial104.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial105.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial106.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial107.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.input().props(
                            'aria-label="Mathematical Applications"'
                        ).classes("sr-only")
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ):
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial111.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial112.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial113.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial121.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial122.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial123.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial124.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial125.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial131.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial132.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial133.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial134.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial135.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial141.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial142.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial143.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial144.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial145.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial146.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial147.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial148.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial149.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial151.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial152.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial153.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial154.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.number(
                            ...
                            max=3,
                            format="%.0f",
                            on_change=lambda e: u_digitalliteracy_trial155.set_value(
                                e.value
                            ),
                        ).classes("w-[600px]").props('aria-label="  "').style(
                            'font-style:normal, font-family: "Atkinson Hyperlegible"'
                ...
                with ui.tab_panel("DATA VISUALIZATION"):
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        def show_table():
                            ...
                            digitalliteracytable.add_slot('body-cell', '''
                                    ...
                                    ''')
                            digitalliteracytable.visible = True
                        ui.button('Show Data', on_click=show_table)
                    with ui.row().classes("w-screen no-wrap py-4").style(
                                'font-style:normal, font-family: "Atkinson Hyperlegible"'
                        ):
                        digitalliteracytable = ui.table(columns=[], rows=[])
                        digitalliteracytable.visible = False
