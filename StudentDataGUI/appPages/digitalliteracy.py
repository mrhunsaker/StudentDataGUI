...
def get_progress_type_id(conn: sqlite3.Connection, name: str) -> int:
    ...
    cur.execute(
        ...
        (name, "Digital literacy skills progression"),
    )
    conn.commit()
    return cur.lastrowid


def get_digitalliteracy_parts(
    ...
    digitalliteracy_parts = [
        # Phase 1
        ("P1_1", "Turn Device On/Off"),
        ("P1_2", "Turn VoiceOver On/Off"),
        ("P1_3", "Gestures to Click Icons"),
        ("P1_4", "Home Screen Icons to Open Documents"),
        ("P1_5", "Save Documents"),
        ("P1_6", "Online Tools/Resources"),
        ("P1_7", "Keyboarding"),
        ("P1_8", "Use Different Elements"),
        ("P1_9", "Control Center, App Switcher..."),
        # Phase 2
        ("P2_1", "Write, edit save"),
        ("P2_2", "Read, Navigate Document"),
        ("P2_3", "Use Menubar"),
        ("P2_4", "Highlight text, copy and paste text"),
        ("P2_5", "Copy and paste images"),
        ("P2_6", "Proofread and edit"),
        # Phase 3
        ("P3_1", "Describe Spreadsheet"),
        ("P3_2", "Explain terms and concepts"),
        ("P3_3", "Enter/Edit data"),
        # Phase 4
        ("P4_1", "Presentation Tools"),
        ("P4_2", "Create Slides"),
        ("P4_3", "Edit Slides"),
        ("P4_4", "Present Slides"),
        ("P4_5", "Share Slides"),
        # Phase 5
        ("P5_1", "Acceptable Use"),
        ("P5_2", "Digital Citizenship"),
        ("P5_3", "Internet Safety"),
        ("P5_4", "Copyright"),
        ("P5_5", "Plagiarism"),
        # Add more as needed...
    ]
...
def create_digitalliteracy_session(
    conn: sqlite3.Connection,
    student_id: int,
...
def insert_digitalliteracy_results(
    conn: sqlite3.Connection,
    session_id: int,
    ...
    """
    part_scores: dict of {code: (part_id, score)}
    """
    cur = conn.cursor()
    ...
    # Use shared artifact helper for horizontal CSV + JSON snapshot
    ...
    write_session_artifacts(
        ...
        notes=notes,
        prefix="DigitalLiteracy",
        layout="horizontal",
        include_json=True,
    )


def fetch_digitalliteracy_data_for_student(
    conn: sqlite3.Connection,
    student_id: int,
    progress_type_id: int,
    part_codes: list[str],
...
def digitalliteracy_skills_ui():
    with theme.frame("- DIGITAL LITERACY SKILLS -"):
        ui.label("Digital Literacy Skills").classes(
            "text-h4 text-grey-8"
        )
        student_name = (
        ...
        def save_digitalliteracy_data():
            ...
            try:
                ...
                progress_type_id = get_progress_type_id(
                    conn, DIGITALLITERACY_PROGRESS_TYPE
                )
                part_ids = get_digitalliteracy_parts(conn, progress_type_id)
                session_id = create_digitalliteracy_session(
                ...
                ui.notify(
                    "Digital Literacy data saved successfully and formatted horizontally in the CSV!",
                    type="positive",
                )
        ...
        ui.button(
            "Save Digital Literacy Data",
            on_click=save_digitalliteracy_data,
            color="primary",
        )
        ...
        def plot_digitalliteracy_data():
            ...
            try:
                ...
                df = fetch_digitalliteracy_data_for_student(
                    conn, student_id, progress_type_id, part_codes
                )
                if df.empty:
                    ui.notify(
                        "No digital literacy data for this student.", type="warning"
                    )
                    return
        ...
        ui.button(
            "Plot Digital Literacy Data",
            on_click=plot_digitalliteracy_data,
            color="secondary",
        )
