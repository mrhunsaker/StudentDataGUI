            ...
            with ui.tab_panels(tabs, value="DATA INPUT"):
                ...
                def create_ui() -> None:
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.input().props(
                            'aria-label="PHASE 2: Word Processing"'
                        ).classes("sr-only")
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ):
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.input().props(
                            'aria-label="PHASE 4: Presentation Tools"'
                        ).classes("sr-only")
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ):
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.input().props(
                            'aria-label="PHASE 5: Digital Literacy"'
                        ).classes("sr-only")
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ):
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        ui.input().props(
                            'aria-label="PHASE 6: Advanced Skills"'
                        ).classes("sr-only")
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        'font-style:normal, font-family: "Atkinson Hyperlegible"'
                    ):
                    ...
                    with ui.row().classes("w-screen no-wrap py-4").style(
                        ...
                        def show_table():
                            ...
                            iostable.add_slot('body-cell', '''
                                    ...
                                    ''')
                            iostable.visible = True
                        ui.button('Show Data', on_click=show_table)
                    with ui.row().classes("w-screen no-wrap py-4").style(
                                'font-style:normal, font-family: "Atkinson Hyperlegible"'
                        ):
                        iostable = ui.table(columns=[], rows=[])
                        iostable.visible = False
