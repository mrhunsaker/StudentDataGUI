...
def create() -> None:
    ...
    def screenreaderskills() -> None:
        with theme.frame("- TECHNOLOGY SKILLS -"):
            ui.label("SCREENREADER SKILLS").classes("text-h4 text-grey-8").style(
        ...
        def create_ui() -> None:
            ...
            ).classes("w-[600px]").props('aria-label="1.6 Switch Program Focus"').style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            )
            with ui.row().classes("w-screen no-wrap py-4").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[600px]").props('aria-label="3.8 Switch tab focus"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
                )
            ui.number(
            ...
            ).classes("w-[600px]").props('aria-label="3.10 Navigate a table"').style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            )
            ui.number(
