...
with ui.tab_panels(tabs, value='BRAILLE SKILLS'):
    with ui.tab_panel('BRAILLE SKILLS'):
        ...
        def save(
            ...
            with open(
                    f"{USER_DIR}\\StudentDatabase\\StudentDataFiles\\{studentname}\\{studentdatabasename}.txt", 'w'
                    ) as filename:
                filename.write('studentname' + ', ')
                filename.write('date' + ', ')
                filename.write('trial11' + ', ')
        ...
        with ui.row().classes('w-full no-wrap py-4 justify-center items-center'):
            ui.number(
                    ...
                    ).classes('w-1/5').props('aria-label="5.1 Page Numbering"').tooltip('5.1 Page Numbering')
            ui.number(
                    label="5.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial52.set_value(e.value)
                    ).classes('w-1/5').props('aria-label="5.2 Headings"').tooltip('5.2 Headings')
            ui.number(
                    label="5.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial53.set_value(e.value)
                    ).classes('w-1/5').props('aria-label="5.3 Lists"').tooltip('5.3 Lists')
            ui.number(
                    label="5.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial54.set_value(e.value)
                    ).classes('w-1/5').props('aria-label="5.4 Poetry / Drama"').tooltip('5.4 Poetry / Drama')
            ui.label(' ').classes('w-1/5')
        with ui.row().classes('w-full no-wrap py-4 justify-center items-center'):
        ...
        with ui.row().classes('w-full no-wrap py-4 justify-center items-center'):
            ui.number(
                    ...
                    ).classes('w-1/5').props('aria-label="7.1 Grade 1 Mode and algebra"').tooltip(
                    '7.1 Grade 1 Mode and algebra'
                    )
            ui.number(
                    label="7.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial72.set_value(e.value)
                    ).classes('w-1/5').props('aria-label="7.2 Grade 1 Mode and Fractions"').tooltip(
                    '7.2 Grade 1 Mode and Fractions'
                    )
            ui.number(
                    label="7.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial73.set_value(e.value)
                    ).classes('w-1/5').props('aria-label="7.3 Advanced Operation and Comparison Signs"').tooltip(
...
with ui.tab_panels(tabs, value='SCREENREADER SKILLS'):
    with ui.tab_panel('SCREENREADER SKILLS'):
        ...
        with ui.row().classes('w-full no-wrap py-4'):
            ui.number(
                    label="1.1", min=0, max=3, format='%.0f', on_change=lambda e: u_trial11.set_value(e.value)
                    ).classes('w-1/7').props('aria-label="1.1 Turn on and off the screen reader"').tooltip(
            ...
            ui.number(
                    ...
                    ).classes('w-1/7').props('aria-label="1.6 Switch Program Focus"').tooltip(
        ...
        with ui.row().classes('w-full no-wrap py-4'):
            ...
            ui.number(
                    label="2.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial24.set_value(e.value)
                    ).classes('w-1/7').props('aria-label="2.4. Select copy and paste text"').tooltip(
        ...
        with ui.row().classes('w-full no-wrap py-4'):
            ...
            ui.number(
                    label="3.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial32.set_value(e.value)
                    ).classes('w-1/7').props('aria-label="3.2 identify each element by type."').tooltip(
                    '3.2 identify each element by type.'
                    )
            ui.number(
                    label="3.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial33.set_value(e.value)
                    ).classes('w-1/7').props('aria-label="3.3 navigate to the address bar"').tooltip(
        ...
        with ui.row().classes('w-full no-wrap py-4'):
            ui.number(
                    label="3.8", min=0, max=3, format='%.0f', on_change=lambda e: u_trial38.set_value(e.value)
                    ).classes('w-1/7').props('aria-label="3.8 Switch tab focus"').tooltip('3.8 Switch tab focus')
            ui.number(
                    label="3.9", min=0, max=3, format='%.0f', on_change=lambda e: u_trial39.set_value(e.value)
                    ).classes('w-1/7').props('aria-label="3.9 Switch between screen reader modes"').tooltip(
                    '3.9 Switch between screen reader modes'
                    )
            ui.number(
                    label="3.10", min=0, max=3, format='%.0f', on_change=lambda e: u_trial310.set_value(e.value)
                    ).classes('w-1/7').props('aria-label="3.10 Navigate a table"').tooltip(
        ...
        with ui.row().classes('w-full no-wrap py-4'):
            ...
            ui.number(
                    ...
                    ).classes('w-1/7').props('aria-label="4.5 Extract zipped folders"').tooltip(
...
with ui.left_drawer(value=True).classes('bg-indigo-500') as left_drawer:
    ...
    ui.button(
            ...
            'text-left w-full align-left bg-red-400 font-bold'
            )
    ui.button(
            'Abacus Made Easy', color='#F98080',
            on_click=lambda: ui.download('instructionMaterials/AbacusMadeEasy.pdf')
            ).classes(
            'text-left w-full align-left font-bold font-bold'
            )
    ui.button(
    ...
    ui.button(
            'NLS-IMBT UEB Literary Braille', color='#F98080',
            on_click=lambda: ui.download('instructionMaterials/')
    ...
    ui.button(
            'UEB with Nemeth', color='#F98080',
            on_click=lambda: ui.download('instructionMaterials/NemethUEBContext')
            ).classes(
            'text-left w-full align-left font-bold'
            )
    ui.label('SCREENREADER').classes('w-full no-wrap py-4 font-bold text-white text-xl justify-center items-center')
    ui.button(
            'NVDA Trainings', color='#F98080',
            on_click=lambda: ui.download('instructionMaterials/NVDATrainings.pdf')
            ).classes(
            'text-left w-full align-left font-bold'
            )
    ui.button(
    ...
    ui.button(
            'Blank Vision Template', color='#F98080',
            on_click=lambda: ui.download('datasheets/BlankVisionTemplate.pdf')
            ).classes(
            'text-left w-full align-left font-bold'
            )
    ui.button(
            'Generic Data Sheets', color='#F98080',
            on_click=lambda: ui.download('datasheets/GenericDataSheets.pdf')
            ).classes(
            'text-left w-full align-left bg-red-400 font-bold'
            )
    ui.button(
