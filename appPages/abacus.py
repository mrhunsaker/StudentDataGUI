    ...
    def abacusskills() -> None:
        ...
        def create_ui() -> None:
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[600px]").props('aria-label="1.3 Place Value"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[600px]").props('aria-label="1.4 Vocabulary"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            ui.input().props('aria-label="PHASE 2: Addition"').classes("sr-only").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            )
            with ui.row().classes("w-screen no-wrap py-4").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[600px]").props('aria-label="3.1 Subtraction"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
                )
            with ui.row().classes("w-screen no-wrap py-4").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[600px]").props('aria-label="8.2 Square Root"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
                )
            with ui.row().classes("w-screen no-wrap py-4").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
