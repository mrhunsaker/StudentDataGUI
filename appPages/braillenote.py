    ...
    def braillenotetouchskills() -> None:
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
                ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Physical Layout"').tooltip("Physical Layout")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Setup/Universal Commands"').tooltip("Setup/Universal Commands")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="BNT+ Navigation"').tooltip("BNT+ Navigation")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="File System navigation"').tooltip("File System navigation")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Main Menu Options"').tooltip("Main Menu Options")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Settings Menus"').tooltip("Settings Menus")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Read Book with EasyReader Plus"').tooltip("Read Book with EasyReader Plus")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Braille Terminal"').tooltip("Braille Terminal")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="System Updates"').tooltip("System Updates")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Creating folders"').tooltip("Creating folders")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Differences among drives, folders, and files"').tooltip("Differences among drives, folders, and files")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Navigating in the file browser"').tooltip("Navigating in the file browser")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Moving, copying and pasting file and folders"').tooltip("Moving, copying and pasting file and folders")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Renaming a file or a folder"').tooltip("Renaming a file or a folder")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Sharing files"').tooltip("Sharing files")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="File and folder commands"').tooltip("File and folder commands")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Editing Document in Keyword"').tooltip("Editing Document in Keyword")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Create a Document in Keyword"').tooltip("Create a Document in Keyword")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Open a Document in Keyword"').tooltip("Open a Document in Keyword")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Save a Document in Keyword"').tooltip("Save a Document in Keyword")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Read a Document in Keyword"').tooltip("Read a Document in Keyword")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Visual Preview"').tooltip("Visual Preview")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Save as Word File"').tooltip("Save as Word File")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Create and edit math object"').tooltip("Create and edit math object")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Insert into KeyWord"').tooltip("Paste into KeyWord")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Generate and Read Graphics"').tooltip("Generate and Read Graphics")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Setting up an email account"').tooltip("Setting up an email account")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Writing and sending emails"').tooltip("Writing and sending emails")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Attaching a file"').tooltip("Attaching a file")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Reading and searching for emails"').tooltip("Reading and searching for emails")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Viewing attached files"').tooltip("Viewing attached files")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Marking, highlighting, deleting, and other email  options"').tooltip("Marking, highlighting, deleting, and other email  options")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Deleting an email account"').tooltip("Deleting an email account")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Launching KeySlides"').tooltip("Launching KeySlides")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Opening a PowerPoint document"').tooltip("Opening a PowerPoint document")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Navigating in your presentation document"').tooltip("Navigating in your presentation document")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Creating appointments"').tooltip("Creating appointments")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Viewing, editing and deleting appointments"').tooltip("Viewing, editing and deleting appointments")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Navigating the agenda"').tooltip("Navigating the agenda")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Navigating Day View"').tooltip("Navigating Day View")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Internet Browsing with Chrome"').tooltip("Internet Browsing with Chrome")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Internet Navigation"').tooltip("Internet Navigation")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    label="8.3 Bookmarks",
                    min=0,
        ...
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Downloading Files"').tooltip("Downloading Files")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Inputting calculations"').tooltip("Inputting calculations")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Inserting a Math symbol in KeyCalc"').tooltip("Inserting a Math symbol in KeyCalc")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Show results as fractions or decimals"').tooltip("Show results as fractions or decimals")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    label="9.4 History",
                    min=0,
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Opening .brf and .brl files"').tooltip("Opening .brf and .brl files")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Creating a .brf or .brl file"').tooltip("Creating a .brf or .brl file")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Finding Braille Text"').tooltip("Finding Braille Text")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Creating a Python File"').tooltip("Creating a Python File")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Opening, Navigating and Editing a Python File"').tooltip("Opening, Navigating and Editing a Python File")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Indentations"').tooltip("Indentations")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Saving a Python File"').tooltip("Saving a Python File")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Coding with KeyCode"').tooltip("Coding with KeyCode")
        with ui.row().classes("w-screen no-wrap py-4"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Third Party Apps"').tooltip("Third Party Apps")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    ...
                    ).classes("w-[400px]").props('aria-label="Downloading"').tooltip("Downloading")
        with ui.row().classes("w-screen no-wrap py-4"): 
            ui.number(
                    label="12.3 Deleting",
                    min=0,
