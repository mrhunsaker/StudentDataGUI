    ...
    def contactlog() -> None:
        with theme.frame("- CONTACT LOG -"):
            ...
            def save(event):
                ...
                contactlog_dictionary = {"studentname": studentname, "date": datenow, "guardianName": guardianName, "contactMethod": contactMethod, "phoneNumber": phoneNumber, "emailAddress": emailAddress, "contactResponse": contactResponse, "contactGeneral": contactGeneral, "contactSpecific": contactSpecific, "contactNotes": contactNotes}
        ...
        with ui.input("Date").classes("w-[300px]").props('aria-label="Date. Please type in date using YYYY-MM-DD format"').tooltip("Date. Please type in date using the YYYY-MM-DD format") as date:
