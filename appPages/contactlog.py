...
def create() -> None:
    ...
    def contactlog() -> None:
        with theme.frame("- COMMUNICATION LOG -"):
            ui.label("CONTACT LOG").classes("text-h4 text-grey-8").style('font-family: "Atkinson Hyperlegible"')
            ...
            u_guardianName = ui.input().classes("hidden").style('font-family: "Atkinson Hyperlegible"')
            u_contactMethod = ui.radio(["Phone", "Text", "In-Person", "Email"]).classes(
                "hidden"
            )
            u_phoneNumber = ui.input().classes("hidden").style('font-family: "Atkinson Hyperlegible"')
            u_emailAddress = ui.input().classes("hidden").style('font-family: "Atkinson Hyperlegible"')
            ...
            u_contactNotes = ui.textarea().classes("hidden").style('font-family: "Atkinson Hyperlegible"')
        ...
        def create_ui() -> None:
            ...
            with ui.row().classes("w-screen no-wrap").style('font-family: "Atkinson Hyperlegible"'):
                ...
                ).classes("w-[600px]").props('aria-label="Guardian Name"').style('font-family: "Atkinson Hyperlegible"').tooltip(
                    "Guardian Name"
                )
            with ui.row().classes("w-screen no-wrap py-4").style('font-family: "Atkinson Hyperlegible"'):
                ui.input(
                ...
                ).classes("w-[600px]").props('aria-label="Phone Number"').style('font-family: "Atkinson Hyperlegible"').tooltip(
                    "Phone Number"
                )
            with ui.row().classes("w-screen no-wrap py-4").style('font-family: "Atkinson Hyperlegible"'):
                ui.input(
                ...
                ).classes("w-[600px]").props('aria-label="Email Address"').style('font-family: "Atkinson Hyperlegible"').tooltip(
                    "Email Address"
                )
            with ui.row().classes("w-screen no-wrap py-4").style('font-family: "Atkinson Hyperlegible"'):
                ui.label().classes("w-[50px]").style('font-family: "Atkinson Hyperlegible"')
            ...
            with ui.row().classes("w-screen no-wrap").style('font-family: "Atkinson Hyperlegible"'):
                ui.label("Contact Method").classes("w-[50px]").style('font-family: "Atkinson Hyperlegible"')
                ui.select(
                    options=["Phone", "Text", "In-Person", "Email"],
                    value="",
                    on_change=lambda e: u_contactMethod.set_value(e.value),
                ).classes("w-[240px]").props('aria-label="Contact Method"').style('font-family: "Atkinson Hyperlegible"').tooltip(
                    "Contact Method"
                )
            with ui.row().classes("w-screen no-wrap py-4").style('font-family: "Atkinson Hyperlegible"'):
                ui.label("Contact Response").classes("w-[50px]").style('font-family: "Atkinson Hyperlegible"')
                ui.select(
                    options=[
                        "Answered",
                        "Left Message",
                ...
                ).classes("w-[240px]").props('aria-label="Contact Response"').style('font-family: "Atkinson Hyperlegible"').tooltip(
                    "Contact Response"
                )
            with ui.row().classes("w-screen no-wrap py-4").style('font-family: "Atkinson Hyperlegible"'):
                ui.label().classes("w-[50px]").style('font-family: "Atkinson Hyperlegible"')
            ...
            with ui.row().classes("w-screen no-wrap").style('font-family: "Atkinson Hyperlegible"'):
                ui.label("General Topic").classes("w-[50px]").style('font-family: "Atkinson Hyperlegible"')
                ui.select(
                ...
                ui.label("Specific Topic").classes("w-[50px]").style('font-family: "Atkinson Hyperlegible"')
                ui.select(
                    options=[
                        "Schedule IEP Meeting",
                        "IEP Team Follow-Up",
            ...
            with ui.row().classes("w-screen no-wrap ").style('font-family: "Atkinson Hyperlegible"'):
                ...
                ).classes("w-[640px]").style('font-family: "Atkinson Hyperlegible"').props(
