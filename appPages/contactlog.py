...
def create() -> None:
    ...
    def contactlog() -> None:
        with theme.frame("- COMMUNICATION LOG -"):
            ...
            u_contactGeneral = (
                ui.radio(["IEP Related", "Discipline Related", "Student Requested"])
                .classes("hidden")
                .style('font-style:normal, font-family: "Atkinson Hyperlegible"')
            )
            u_contactSpecific = (
        ...
        def create_ui() -> None:
            ...
            with ui.row().classes("w-screen no-wrap").style(
                ...
                ).classes("w-[600px]").props('aria-label="Guardian Name"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[600px]").props('aria-label="Email Address"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap").style(
                ...
                ).classes("w-[240px]").props('aria-label="Contact Method"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[240px]").props('aria-label="Contact Response"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap").style(
                ...
                ui.select(
                    ...
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
                ).props('aria-label="Reason for Contact - General Category"').tooltip(
            ...
            with ui.row().classes("w-screen no-wrap").style(
                ...
                ui.select(
                    ...
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
                ).props('aria-label="Reason for Contact - Specific Reason"').tooltip(
