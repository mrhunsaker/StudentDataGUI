    ...
    with ui.row().classes("w-screen no-wrap py-4 pl-10"):
        ui.markdown(
            """
                                            ...
                                            help
                                            TVIs engage in data-based
                                            decision making. The app is
                                            designed to be screenreader
                                            accessible using all known
                                            screenreaders (specifically
                                            tested with JAWS, NVDA,
        ...
        ui.markdown(
            """
                                            ...
                                            - Navigation
                                                ...
                                                designed to
                                                be worked with a
                                                screenreader using the
                                                **TAB** key.
                                                - Tab through each
                                                option
                                                and follow audio prompts
                                                (if using a
                                                screenreader)
                                                or tooltips (if not) to
                                                input data
                                                - Press the "Exit"
                                                button
                                                to close the app. Then
                                            ...
                                            - Data Input
                                                - Select the Student
                                                from
                                                the drop-down menu (it
                                                will autofill when you
                                                type as well)
                                                - Choose the Date using
                                                the date picker or else
                                                type in the date using
                                                ...
                                                or 3 Rubric value
                                                - Activate the "Save"
                                                button to save data to
                                                .csv format as well
                                                as to
                                                a Database
                                            - Data Visualization
                                                - Press the "Graph"
                                                button to pull saved
                                                data
                                                and open interactive
                                                plots in a new window.
                                                - The graph is also
                                                saved
                                                in HTML format in the
                                                Student data folder
                                                """
        )
