...
def create() -> None:
    ...
    def iosskillsprogression() -> None:
        with theme.frame("- TECHNOLOGY SKILLS -"):
            ui.label("iOS / iPad OS  SKILLS").classes("text-h4 text-grey-8").style(
        ...
        def create_ui() -> None:
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ui.label("PHASE 1: Navigation").classes(
                    "justify-center items-center text-lg"
                ).style('font-style:normal, font-family: "Atkinson Hyperlegible"')
                ui.input().props('aria-label="PHASE 1: Navigation"').classes(
                    "sr-only"
                ).style('font-style:normal, font-family: "Atkinson Hyperlegible"')
            with ui.row().classes("w-screen no-wrap py-4").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
                ...
                ).classes("w-[600px]").props('aria-label="Turn Device On/Off"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
                )
            with ui.row().classes("w-screen no-wrap py-4").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ).classes("w-[600px]").props('aria-label="Save Documents"').style(
                    'font-style:normal, font-family: "Atkinson Hyperlegible"'
                )
            with ui.row().classes("w-screen no-wrap py-4").style(
                'font-style:normal, font-family: "Atkinson Hyperlegible"'
            ...
            with ui.row().classes("w-screen no-wrap py-4").style(
                ...
                ui.label("PHASE 3: Spreadsheets").classes(
                    "justify-center items-center text-lg"
                ).style('font-style:normal, font-family: "Atkinson Hyperlegible"')
