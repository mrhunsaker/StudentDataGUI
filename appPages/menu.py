...
def menu() -> None:
    ...
    with ui.button(icon='menu').classes():
        with ui.menu().classes("w-[250px]") as menu:
            ...
            ui.separator()
            ui.menu_item(
                    "CONTACT LOG", lambda: ui.open(
                            '/contactlog'
                            )
                    ).classes(replace='text-black')
            ui.menu_item(
                    "ANECDOTAL NOTES", lambda: ui.open(
                            '/anecdotalnotes'
                            )
                    ).classes(replace='text-black')
            ...
            ui.menu_item(
                    "ABACUS SKILLS", lambda: ui.open(
                            '/abacusskills'
                            )
                    ).classes(replace='text-black')
            ui.menu_item(
                    "BRAILLE SKILLS", lambda: ui.open(
                            '/brailleskills'
                            )
                    ).classes(replace='text-black')
            ui.separator()
            ...
            ui.menu_item(
                    "SCREENREADER SKILLS", lambda: ui.open(
                            '/screenreaderskills'
                            )
                    ).classes(
                    replace='text-black'
            ...
            ui.menu_item(
                    "BRAILLENOTE TOUCH SKILLS", lambda: ui.open(
                            '/braillenotetouchskills'
                            )
                    ).classes(
                    replace='text-black'
                    )
            ui.menu_item(
                    "iOS/iPadOS VOICEOVER SKILLS", lambda: ui.open(
                            '/iosskills'
                            )
                    ).classes(replace='text-black')
            ui.separator()
            ...
            ui.menu_item(
                    "INSTRUCTIONAL MATERIALS", lambda: ui.open(
