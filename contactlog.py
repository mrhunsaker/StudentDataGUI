...
for name in students:
    ...
    if (
        not Path(USER_DIR)
        .joinpath("StudentDatabase", "StudentDataFiles", name, "omnibusDatabase.csv")
        .exists()
    ):
        tmppath = Path(USER_DIR).joinpath(
    ...
    if (
        not Path(USER_DIR)
        .joinpath(
            "StudentDatabase", "StudentDataFiles", name, "BrailleSkillsProgression.csv"
        )
        .exists()
    ):
        tmppath = Path(USER_DIR).joinpath(
    ...
    if (
        not Path(USER_DIR)
        .joinpath(
            "StudentDatabase", "StudentDataFiles", name, "AbacusSkillsProgression.csv"
        )
        .exists()
    ):
        tmppath = Path(USER_DIR).joinpath(
    ...
    if (
        not Path(USER_DIR)
        .joinpath(
            "StudentDatabase", "StudentDataFiles", name, "AbacusSkillsProgression.html"
        )
        .exists()
    ):
        tmppath = Path(USER_DIR).joinpath(
    ...
    if (
        not Path(USER_DIR)
        .joinpath("StudentDatabase", "StudentDataFiles", name, "cviProgression.html")
        .exists()
    ):
        tmppath = Path(USER_DIR).joinpath(
...
with ui.tab_panels(tabs, value="CONTACT LOG"):
    with ui.tab_panel("CONTACT LOG"):
        u_studentname = ui.select(options=students, value="DonaldChamberlain").classes(
            "hidden"
        )
...
with ui.tab_panels(tabs, value="ABACUS SKILLS"):
    with ui.tab_panel("ABACUS SKILLS"):
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ...
            ui.input().props(
                'aria-label="PHASE 1: Setting and Clearing Numbers" ' "content-center"
            ).classes("sr-only")
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="1.1", value="", on_change=lambda e: u_trial11.set_value(e.value)
            ).classes("w-[200px]").props('aria-label="1.1 Setting Numbers"').tooltip(
                "1.1 Setting Numbers"
            )
            ui.number(
                label="1.2", value="", on_change=lambda e: u_trial12.set_value(e.value)
            ).classes("w-[200px]").props('aria-label="1.2 Clearing Numbers"').tooltip(
                "1.2 Clearing Numbers"
            )
            ui.number(
                label="1.3", value="", on_change=lambda e: u_trial13.set_value(e.value)
            ).classes("w-[200px]").props('aria-label="1.3 Place Value"').tooltip(
                "1.3 Place Value"
            )
            ui.number(
                label="1.4", value="", on_change=lambda e: u_trial14.set_value(e.value)
            ).classes("w-[200px]").props('aria-label="1.4 Vocabulary"').tooltip(
                "1.4 Vocabulary"
            )
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.label("PHASE 2: Addition").classes("justify-center items-center")
            ui.input().props('aria-label="PHASE 2: Addition" content-center').classes(
                "sr-only"
            )
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="2.1", value="", on_change=lambda e: u_trial21.set_value(e.value)
            ...
            ui.number(
                label="2.2", value="", on_change=lambda e: u_trial22.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="2.3", value="", on_change=lambda e: u_trial23.set_value(e.value)
            ).classes("w-[200px]").props(
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="3.1", value="", on_change=lambda e: u_trial31.set_value(e.value)
            ).classes("w-[200px]").props('aria-label="3.1 Subtraction"').tooltip(
                "3.1 Subtraction"
            )
            ui.number(
                label="3.2", value="", on_change=lambda e: u_trial32.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="3.3", value="", on_change=lambda e: u_trial33.set_value(e.value)
            ).classes("w-[200px]").props(
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="4.1", value="", on_change=lambda e: u_trial41.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="4.2", value="", on_change=lambda e: u_trial42.set_value(e.value)
            ).classes("w-[200px]").props(
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ...
            ui.input().props('aria-label="PHASE 5: Division" content-center').classes(
                "sr-only"
            )
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="5.1", value="", on_change=lambda e: u_trial51.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="5.2", value="", on_change=lambda e: u_trial52.set_value(e.value)
            ).classes("w-[200px]").props(
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ...
            ui.input().props('aria-label="PHASE 6: Decimals" content-center').classes(
                "sr-only"
            )
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="6.1", value="", on_change=lambda e: u_trial61.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="6.2", value="", on_change=lambda e: u_trial62.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="6.3", value="", on_change=lambda e: u_trial63.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="6.4", value="", on_change=lambda e: u_trial64.set_value(e.value)
            ).classes("w-[200px]").props(
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ...
            ui.input().props('aria-label="PHASE 7: Fractions" content-center').classes(
                "sr-only"
            )
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="7.1", value="", on_change=lambda e: u_trial71.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="7.2", value="", on_change=lambda e: u_trial72.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="7.3", value="", on_change=lambda e: u_trial73.set_value(e.value)
            ).classes("w-[200px]").props(
            ...
            ui.number(
                label="7.4", value="", on_change=lambda e: u_trial74.set_value(e.value)
            ).classes("w-[200px]").props(
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                label="8.1", value="", on_change=lambda e: u_trial81.set_value(e.value)
            ).classes("w-[200px]").props('aria-label="8.1 Percent"').tooltip(
                "8.1 Percent"
            )
            ui.number(
                label="8.2", value="", on_change=lambda e: u_trial82.set_value(e.value)
    ...
    with ui.tab_panel("BRAILLE SKILLS"):
        ...
        def graph(event):
            ...
            fig.update_layout(
                ...
                xaxis3_tickformat="%d %b",
                template="simple_white",
                title_text=f"{studentname}: Technical UEB Skills " f"Progression",
                legend=dict(font=dict(size=10)),
            )
            tmppath = Path(USER_DIR).joinpath(
                "StudentDatabase",
...
with ui.tab_panels(tabs, value="SCREENREADER SKILLS"):
    with ui.tab_panel("SCREENREADER SKILLS"):
        ...
        def save(event):
            ...
            studentdatabasename = f"screenreader{studentname.title()}" f"{datenow}"
            tmppath = Path(USER_DIR).joinpath(
                "StudentDatabase",
                "StudentDataFiles",
                studentname,
        ...
        def graph(event):
            ...
            fig.update_layout(
                template="simple_white",
                title_text=f"{studentname}: Screen Reader Skills " f"Progression",
            )
            tmppath = Path(USER_DIR).joinpath(
                "StudentDatabase",
                "StudentDataFiles",
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ...
            ui.number(
                ...
                "3.6 Use Elements Lists on a website to navigate by " "element " "type"
            )
            ui.number(
                label="3.7",
                min=0,
        ...
        with ui.row().classes("w-screen no-wrap py-4"):
            ui.number(
                ...
                format="%.0f",
                on_change=lambda e: u_trial38.set_value(e.value),
            ).classes("w-[200px]").props('aria-label="3.8 Switch tab focus"').tooltip(
            ...
            ui.number(
                ...
                format="%.0f",
                on_change=lambda e: u_trial310.set_value(e.value),
            ).classes("w-[200px]").props('aria-label="3.10 Navigate a table"').tooltip(
...
with ui.left_drawer(value=True).classes("bg-blue-950") as left_drawer:
    ...
    with ui.row().classes("w-full no-wrap py-4"):
        ui.link(
            ...
            new_tab=True,
        ).classes("text-left w-full text-white align-left font-bold font-bold")
    with ui.row().classes("w-full no-wrap py-4"):
        ui.link(
...
for monitor in get_monitors():
    print(f"Screen Resolution = {str(monitor.width)}x" f"{str(monitor.height)}")
##############################################################################
# RUN CALL
##############################################################################
ui.run(
