        ...
        with ((((theme.frame('- CVI PROGRESSION-'))))):
            ...
            def save(event):
                ...
                with open(tmppath, "w") as filename:
                    ...
                    filename.write("date" + ", ")
                    filename.write("cvi_trial11" + ", ")
                    filename.write("cvi_trial12" + ", ")
                    filename.write("cvi_trial13" + ", ")
                    filename.write("cvi_trial14" + ", ")
                    filename.write("cvi_trial21" + ", ")
                    filename.write("cvi_trial22" + ", ")
                    filename.write("cvi_trial23" + ", ")
                    filename.write("cvi_trial31" + ", ")
                    filename.write("cvi_trial32" + ", ")
                    filename.write("cvi_trial33" + ", ")
                    filename.write(studentname + ", ")
                    filename.write(date + ", ")
                    filename.write(str(cvi_trial11) + ", ")
                    filename.write(str(cvi_trial12) + ", ")
                    filename.write(str(cvi_trial13) + ", ")
                    filename.write(str(cvi_trial14) + ", ")
                    filename.write(str(cvi_trial21) + ", ")
                    filename.write(str(cvi_trial22) + ", ")
                    filename.write(str(cvi_trial23) + ", ")
                    filename.write(str(cvi_trial31) + ", ")
                    filename.write(str(cvi_trial32) + ", ")
                    filename.write(str(cvi_trial33) + ", ")
                    filename.close()
                    ...
                    filename.write(f"'{tmppath}'" + "\n")
                    filename.close()
                    list_data = [datenow, cvi_trial11, cvi_trial12, cvi_trial13, cvi_trial14, cvi_trial21, cvi_trial22, cvi_trial23, cvi_trial31, cvi_trial32, cvi_trial33]
                    ...
                    def data_entry():
                        ...
                        c = conn.cursor()
                        c.execute("""INSERT INTO CVIPROGRESS (
                                        STUDENTNAME,
                                        DATE,
                                        P1_1,
                                        P1_2,
                                        ...
                                        VALUES (
                                            ...
                                            ?,
                                            ?
                                            )""", (studentname, datenow, cvi_trial11, cvi_trial12, cvi_trial13, cvi_trial14, cvi_trial21, cvi_trial22, cvi_trial23, cvi_trial31, cvi_trial32, cvi_trial33), )
                        conn.commit()
            ...
            def graph(event):
                ...
                df_noisy = df + noise
                fig = make_subplots(rows=5, cols=2, subplot_titles=("Color Preference", "Need for Movement", "Latency", "Field Preference", "Visual Complexity", "Nonpurposeful Gaze", "Distance Viewing", "Atypical Reflexes", "Visual Novelty", "Visual Reach"), print_grid=True)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_1"], mode="lines+markers", name="Color Preference", legendgroup="", legendgrouptitle_text=" "), row=1, col=1)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_2"], mode="lines+markers", name="Need for Movement", legendgroup="Phase 1", legendgrouptitle_text="Phase 1"), row=1, col=2)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_3"], mode="lines+markers", name="Latency", legendgroup="", legendgrouptitle_text=" "), row=2, col=1)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_4"], mode="lines+markers", name="Field Prefence", legendgroup="", legendgrouptitle_text=" "), row=2, col=2)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_5"], mode="lines+markers", name="Visual Complexity", legendgroup="", legendgrouptitle_text=" "), row=3, col=1)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_6"], mode="lines+markers", name="Nonpurposeful Gaze", legendgroup="", legendgrouptitle_text=" "), row=3, col=2)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P2_1"], mode="lines+markers", name="Distance Viewing", legendgroup="", legendgrouptitle_text=" "), row=4, col=1)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P2_2"], mode="lines+markers", name="Atypical Reflexes", legendgroup="", legendgrouptitle_text=" "), row=4, col=2)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P2_3"], mode="lines+markers", name="Visual Novelty", legendgroup="", legendgrouptitle_text=" "), row=5, col=1)
                fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P2_4"], mode="lines+markers", name="Visual Reach", legendgroup="Phase 3", legendgrouptitle_text=" "), row=5, col=2)
                ...
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=1, col=1)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=1, col=2)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=2, col=1)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=2, col=2)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=3, col=1)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=3, col=2)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=4, col=1)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=4, col=2)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=5, col=1)
                fig.update_yaxes(range=[-.5, 3.5], fixedrange=True, ticktext=["Phase 1", "Phase 2", "Phase 3", "Resolving"], tickvals=[0.1, 1, 2, 3], row=5, col=2)
            ...
            with ui.row().classes("w-screen no-wrap py-4"):
                ui.number(label="Color Preference", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial11.set_value(e.value), ).classes("w-[200px]").props('aria-label="Color Preference"').tooltip("Color Preference")
                ui.number(label="Need for Movement", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial12.set_value(e.value), ).classes("w-[200px]").props('aria-label="Need for Movement"').tooltip("Need for Movement")
                ui.number(label="Latency", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial13.set_value(e.value), ).classes("w-[200px]").props('aria-label="Latency"').tooltip("Latency")
                ui.number(label="Field Preference", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial14.set_value(e.value), ).classes("w-[200px]").props('aria-label="Field Preference"').tooltip("Field Preference")
                ui.number(label="Visual Complexity", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial21.set_value(e.value), ).classes("w-[200px]").props('aria-label="Visual Complexity"').tooltip("Visual Complexity")
            with ui.row().classes("w-screen no-wrap py-4"):
                ui.number(label="Nonpurposeful Gaze", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial22.set_value(e.value), ).classes("w-[200px]").props('aria-label="Nonpurposeful Gaze"').tooltip("Nonpurposeful Gaze")
                ui.number(label="Distance Viewing", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial23.set_value(e.value), ).classes("w-[200px]").props('aria-label="Distance Viewing"').tooltip("Distance Viewing")
                ui.number(label="Atypical Reflexes", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial31.set_value(e.value), ).classes("w-[200px]").props('aria-label="Atypical Reflexes"').tooltip("Atypical Reflexes")
                ui.number(label="Visual Novelty", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial32.set_value(e.value), ).classes("w-[200px]").props('aria-label="Visual Novelty"').tooltip("Visual Novelty")
                ui.number(label="Visual Reach", min=0, max=3, format="%.0f", on_change=lambda e: u_cvi_trial33.set_value(e.value), ).classes("w-[200px]").props('aria-label="Visual Reach"').tooltip("Visual Reach")
            with ui.row().classes("w-screen no-wrap py-4"):
