    ...
    for name in students:
        ...
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "omnibusDatabase.csv").exists():
            ...
            list_names = ["student", "date", "task", "lesson", "session", "trial01", "trial02", "trial03", "trial04",
                          "trial05", "trial06", "trial07", "trial08", "trial09", "trial10", "trial11", "median",
                          "notes", ]
        ...
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "cviProgression.html").exists():
            ...
            Path.touch(tmppath)
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "hsdigitalliteracyProgression.csv").exists():
            tmppath = Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "hsdigitalliteracyProgression.csv")
            Path.touch(tmppath)
            list_names = ["date", "P1_1", "P1_2", "P1_3", "P1_4", "P1_5", "P2_1", "P2_2", "P2_3", "P2_4", "P2_5",
                          "P2_6", "P2_7", "P3_1", "P3_2", "P3_3", "P3_4", "P3_5", "P3_6", "P3_7", "P4_1", "P4_2",
                          "P4_3", "P5_1", "P5_2", "P5_3", "P5_4", "P5_5", "P6_1", "P6_2", "P6_3", "P6_4", "P6_5",
                          "P7_1", "P7_2", "P7_3", "P7_4", "P7_5", "P7_6", "P7_7", "P7_8", "P7_9", "P8_1", "P8_2",
                          "P8_3", "P8_4", "P8_5"]
            with open(tmppath, "a", newline="", encoding="UTF-8") as f_object:
                writer_setup = writer(f_object)
                writer_setup.writerow(list_names)
                f_object.close()
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "hsdigitalliteracyProgression.html").exists():
            tmppath = Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "hsdigitalliteracyProgression.html")
            Path.touch(tmppath)
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "elemdigitalliteracyProgression.csv").exists():
            tmppath = Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "elemdigitalliteracyProgression.csv")
            Path.touch(tmppath)
            list_names = ["date", "P1_2", "P1_3", "P1_4", "P1_5", "P1_6", "P2_1", "P2_2", "P2_3", "P2_4", "P2_5",
                          "P2_6", "P3_1", "P3_2", "P3_3", "P3_4", "P3_5", "P4_1", "P4_2", "P4_3", "P4_4", "P4_5",
                          "P5_1", "P5_2", "P5_3", "P5_4", "P5_5", "P5_6", "P5_7", "P6_1", "P6_2", "P6_3", "P6_4",
                          "P7_1", "P7_2", "P7_3", "P7_4", "P7_5", ]
            with open(tmppath, "a", newline="", encoding="UTF-8") as f_object:
                writer_setup = writer(f_object)
                writer_setup.writerow(list_names)
                f_object.close()
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "elemdigitalliteracyProgression.html").exists():
            tmppath = Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "elemdigitalliteracyProgression.html")
            Path.touch(tmppath)
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "iosProgression.csv").exists():
            ...
            Path.touch(tmppath)
            list_names = ["date", "P1_1", "P1_2", "P1_3", "P1_4", "P1_5", "P1_6", "P1_7", "P1_8", "P1_9", "P2_1",
                          "P2_2", "P2_3", "P2_4", "P2_5", "P2_6", "P3_1", "P3_2", "P3_3", "P3_4", "P3_5", "P4_1",
                          "P4_2", "P4_3", "P4_4", "P4_5", "P5_1", "P5_2", "P5_3", "P5_4", "P5_5", "P5_6", "P5_7",
        ...
        if not Path(USER_DIR).joinpath("StudentDatabase", "StudentDataFiles", name, "bntProgression.csv").exists():
            ...
            Path.touch(tmppath)
            list_names = ["date", "P1_1", "P1_2", "P1_3", "P1_4", "P1_5", "P1_6", "P1_7", "P1_8", "P1_9", "P2_1",
                          "P2_2", "P2_3", "P2_4", "P2_5", "P2_6", "P2_7", "P3_1", "P3_2", "P3_3", "P3_4", "P3_5",
                          "P3_6", "P3_7", "P4_1", "P4_2", "P4_3", "P5_1", "P5_2", "P5_3", "P5_4", "P5_5", "P5_6",
                          "P5_7", "P6_1", "P6_2", "P6_3", "P7_1", "P7_2", "P7_3", "P7_4", "P8_1", "P8_2", "P8_3",
                          "P8_4", "P8_5", "P9_1", "P9_2", "P9_3", "P9_4", "P10_1", "P10_2", "P10_3", "P11_1", "P11_2",
