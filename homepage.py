...
def content() -> None:
    ui.label('VISION SKILLS PROGRESSIONS').classes('text-h4 font-bold text-grey-8')
    with ui.row().classes("w-screen no-wrap py-4"):
        ui.markdown('''
                            ### About this app
                            This app was designed to help TVIs engage in data-based  decision making. The app is designed to be screenreader accessible using all known screenreaders (specifically tested with JAWS, NVDA, Dolphin ScreenReader, Narrator,
                            and ZDSR).
                        ''')
    with ui.row().classes("w-screen no-wrap py-4"):
        ui.markdown('''
    ...
    with ui.row().classes("w-screen no-wrap py-4"):
        ui.markdown('''
                ...
                | 1            | Required Assistance | Student needs to learn to quickly reconize what skills is  needed |
                ...
                The motivation for this system is from the Screen Reader Skills
                Progression course available at eyeTvision.org
                ''', extras=['tables'])
    ...
    with ui.row().classes("w-screen no-wrap py-4"):
        ui.markdown('''
                ...
                On initial setup, the program tries to set up the following
