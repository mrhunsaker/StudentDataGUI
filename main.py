...
##############################################################################
students = ['ColeCooper', 'LandonGraham', 'TarelLewis', 'DynPenalozaDiaz',
            'CarterCostello', 'MadelineCostello',
            'SuttonBuell', 'MargaretWalker', 'TysonGraham', 'AddisonBooker',
            'AmiRito', 'AshlynneNelson',
            'CarstonTalbot', 'CelestialNeilson', 'LanedonLee', 'NoahPalmer',
            'PaulaSackett']

students_all = ['AddisonBooker', 'AlaijahValdez', 'AlessaPurcel',
                'AlexRoylance', 'AmiRito', 'AmmonOlsen',
                'AshlynnNelson', 'AustinDenney', 'AvaWilson', 'BaraahAlArbid',
                'BelleOsborn', 'BrightonTingey',
                'BryceClark', 'CallumDavis', 'CarstonTalbot', 'CarterCostello',
                'CasonHemphill', 'CelestialNeilson',
                'CharlieChristensen', 'ChaseCreer', 'ChristiGriffin',
                'ColbieBlodgett', 'ColeCooper', 'ColeHalbasch',
                'ConnorDenney', 'CristianPerez', 'CruAnderson', 'DaltonCarter',
                'DylanPenalozaDiaz', 'EleanorParson',
                'EllaLechtenberg', 'ElliotWhite', 'ElyseStephensen',
                'EmmaThompson', 'EmmaTorres', 'EvieCompton',
                'FrancisAnwar', 'FrancisLeyva', 'GenevieveBriceno',
                'GraceDavis', 'GrantChristensen', 'HadleyKelleher',
                'HalleGallacher', 'HannahHadean', 'HillaryWheeler',
                'HunterHaskell', 'HunterTrevino', 'IsaacChiakis',
                'JacksonJohnson', 'JacksonWhitear', 'JainaKarakusis',
                'JakeHeairld', 'JayceAbles', 'JaydenSmith',
                'JeffreyLeishman', 'JonathanChesnovar', 'JulieMartin',
                'JustinBadham', 'KahvonFord', 'KaitlinStott',
                'KatelynChamberlain', 'KayleeVimahi', 'KaysonWallwork',
                'Kenzie Bybee', 'KenzieBybee', 'KinisouElimo',
                'KiraAgamez', 'KiyrahMiller', 'LandonGraham', 'LandonUlrich',
                'LanedanLee', 'LaurenArnesen', 'Liaison',
                'LillyVanwagoner', 'LincolnHoke', 'LucasKirby',
                'LukeMontgomery', 'MackenzieMcclean',
                'MadelineCostello', 'MagnusWilson', 'MallieMartin',
                'MargaretWalker', 'MarilynParker', 'MaryJaneBlack',
                'MayaHegoas', 'MeelaZendejas', 'MichelleCorrea',
                'MilesWebster', 'MillieBeckstead', 'NadiaBurns',
                'NoahPalmer', 'NoraBarton', 'OliverPage', 'OliviaEvershed',
                'PaulaSackett', 'PrestonPage',
                'RachelBallard', 'RachelScott', 'RyderReddig', 'RykerWeight',
                'SamuelWilliam', 'SamuelWilliams',
                'SaraHill', 'SavannahWinegar', 'ShelbySteed',
                'SpencerCostello', 'SuttonBuell', 'TalmageTingey',
                'TarelLewis', 'TaylorTroxel', 'TheodoreLloyd', 'TjGutierrez',
                'TyGoddard', 'TylerAshby', 'TysonGraham',
                'WestonHemphill', 'WilliamHayes', 'WilliamJackson',
                'WilliamMacKay', 'ZoeyFerguson', ]

taskType = ['braille', 'screenreader', 'abacus', 'iOS', 'magnifierSkills',
            'Expanded Core Curriculum']

sessionType = ['ProgressMonitor', 'Instruction', 'Assessment']
...
iOSSkills = ['Select and speak an item', 'Select the previous / next item',
             ...
             'Drag over the screen', 'Scroll up /down one page',
             'Scroll left / right  one page',
             'Activate the selected item', 'Double-tap the selected item',
             'Drag a slider',
             'Dismiss an alert or return to the previous screen',
             'Edit an item label to make it easier to find',
             'Navigate forms', 'Help with current element',
             'Toggle screen curtain on/off',
             'Split tap quick activation', 'Double-press button',
             'Speak words/characters typed',
             'Access control center', 'Backspace',
             'Write letters, numbers, punctation',
             'Change case, punctuation, numbers', 'Insert space',
             'Choose a rotor setting', 'Change keyboard mode']
...
abacusSkills = ['1.1. Setting Numbers', '1.2. Clearing Beads',
                '1.3. Place Value', '1.4. Vocabulary',
                ...
                '6.3. Multiplication of Decimals', '6.4. Division of Decimals',
                '7.1. Addition of Fractions', '7.2. Subtraction of Fractions',
...
screenreaderSkills = ['1.1. Turn on and off the screen reader',
                      '1.2 Utilize modifier keys ', '1.3. Read text ',
                      ...
                      '4.6. Utilize virtual cursors', '4.7. Use OCR']

brailleSkills = ['1.1. Track left to right', '1.2. Track top to bottom',
                 ...
                 '3.2. Braille Numbers', '3.3. Punctuation',
                 ...
                 '3.11. Dot 5 Contractions', '3.12. Dot 45 Contractions',
                 '3.13. Dot 456 Contractions', '3.14. Final Letter Groupsigns',
                 '3.15. Shortform Words',
                 '4.1. Grade 1 Indicators', '4.2. Capitals Indicators',
                 '4.3. Numeric Mode and Spatial math',
                 '4.4. Typeform Indicators (ITALIC, SCRIPT, UNDERLINE, BOLDFACE)',
                 '5.1. Page Numbering',
                 '5.2. Headings', '5.3. Lists', '5.4. Poety / Drama',
                 '6.1.  Operation and Comparison Signs',
                 '6.2. Grade 1 Mode', '6.3. Special Print Symbols',
                 '6.4. Omission Marks', '6.5. Shape Indicators',
                 '6.6. Roman Numerals', '6.7. Fractions',
                 ...
                 '7.6. Miscellaneous Shape Indicators', '7.7. Functions',
                 '7.8. Greek letters', '8.1. Functions',
                 '8.2. Modifiers, Bars, and Dots',
                 '8.3. Modifiers, Arrows, and Limits', '8.4. Probability',
                 '8.5. Calculus: Differentiation',
                 '8.6. Calculus: Integration', '8.7. Vertical Bars']

cviDomains = ['colorPreference', 'needForMovement', 'visualLatency',
              'visualFieldPreference', 'visualComplexity',
              'nonpurposefulGaze', 'distanceViewing', 'visualReflexes',
              'visualNovelty', 'visuallyGuidedReach']
...
for name in students:
    ...
    if not Path(USER_DIR).joinpath('StudentDatabase', 'StudentDataFiles', name,
        ...
        list_names = ['student', 'date', 'task', 'lesson', 'session',
...
class dataPanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.session1 = wx.Choice(self, -1, choices=sessionType,
                                  pos=(130, 110), size=(300, 20))
        ...
        self.item8 = self.lesson1.AppendItem(self.root,
                                             'ECC_SensoryEfficiency')
        ...
        self.trial011 = wx.TextCtrl(self, -1, "", pos=(650, 80),
                                    size=(300, 20))
        ...
        self.notes1 = wx.TextCtrl(self, -1, "", pos=(650, 440),
    ...
    def save(self, event):
        ...
        trials = [trial01, trial02, trial03, trial04, trial05, trial06,
        ...
        def data_entry():
            ...
            c.execute(
                ...
                (studentname, dateNow, task, lesson, session, trial01, trial02,
                 trial03, trial04, trial05, trial06,
...
class braillePanel(scrolled.ScrolledPanel):
    def __init__(self, parent):
        ...
        self.trial14 = wx.TextCtrl(self, -1, "", pos=(650, 170),
                                   size=(300, 20))
        wx.StaticText(self, -1, "2.1 Mangold Progression: G C L",
                      pos=(30, 200))
        ...
        self.trial31 = wx.TextCtrl(self, -1, "", pos=(650, 650),
                                   size=(300, 20))
        wx.StaticText(self, -1, "3.2 Braille Numbers", pos=(30, 680))
        self.trial32 = wx.TextCtrl(self, -1, "", pos=(650, 680),
                                   size=(300, 20))
        wx.StaticText(self, -1, "3.3 Punctuation", pos=(30, 710))
        self.trial33 = wx.TextCtrl(self, -1, "", pos=(650, 710),
                                   size=(300, 20))
        wx.StaticText(self, -1,
                      "3.4 Strong Contractions - AND OF FOR WITH THE",
                      pos=(30, 740))
        self.trial34 = wx.TextCtrl(self, -1, "", pos=(650, 740),
                                   size=(300, 20))
        wx.StaticText(self, -1,
                      "3.5 Strong Groupsigns - CH GH SH TH WH ED ER OU OW ST AR ING",
                      pos=(30, 770))
        self.trial35 = wx.TextCtrl(self, -1, "", pos=(650, 770),
                                   size=(300, 20))
        wx.StaticText(self, -1, "3.6 Strong Wordsigns - CH SH TH WH OU ST",
                      pos=(30, 800))
        self.trial36 = wx.TextCtrl(self, -1, "", pos=(650, 800),
                                   size=(300, 20))
        wx.StaticText(self, -1, "3.7 Lower Groupsigns - BE CON DIS",
                      pos=(30, 830))
        self.trial37 = wx.TextCtrl(self, -1, "", pos=(650, 830),
                                   size=(300, 20))
        wx.StaticText(self, -1, "3.8 Lower Groupsigns - EA BB CC FF GG",
                      pos=(30, 860))
        self.trial38 = wx.TextCtrl(self, -1, "", pos=(650, 860),
                                   size=(300, 20))
        wx.StaticText(self, -1, "3.9 Lower Group/Wordsigns - EN IN",
                      pos=(30, 890))
        self.trial39 = wx.TextCtrl(self, -1, "", pos=(650, 890),
                                   size=(300, 20))
        ...
        self.trial81 = wx.TextCtrl(self, -1, "", pos=(650, 1790),
                                   size=(300, 20))
        wx.StaticText(self, -1, "8.2 Modifiers, Bars, and Dots",
                      pos=(30, 1820))
        ...
        self.trial84 = wx.TextCtrl(self, -1, "", pos=(650, 1880),
                                   size=(300, 20))
        wx.StaticText(self, -1, "8.5 Calculus: Differentiation",
                      pos=(30, 1910))
            ...
            if not Path(USER_DIR).joinpath('StudentDatabase',
                ...
                with open(tmpPath, 'a', newline='') as f_setup:
                    list_data = [dateNow, trial11, trial12, trial13, trial14,
                                 ...
                                 trial38, trial39, trial310, trial311,
                                 trial312, trial313, trial314, trial315,
                                 trial41,
        ...
        def data_entry():
            ...
            c.execute(
                ...
                (studentname, dateNow, trial11, trial12, trial13, trial14,
                 ...
                 trial31, trial32, trial33, trial34, trial35, trial36, trial37,
                 trial38, trial39, trial310, trial311,
                 trial312, trial313, trial314, trial315, trial41, trial42,
                 trial43, trial44, trial51, trial52, trial53,
                 trial54, trial61, trial62, trial63, trial64, trial65, trial66,
                 trial67, trial71, trial72, trial73,
                 trial74, trial75, trial76, trial77, trial78, trial81, trial82,
                 trial83, trial84, trial85, trial86,
                 trial87))
            conn.commit()
            data_entry()
    ...
    def graph(self, event):
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P1_1'],
                       mode="lines+markers", name="Track left to right",
                       legendgroup="Phase 1", legendgrouptitle_text="Phase 1"),
            row=1, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P1_2'],
                       mode="lines+markers", name="Track top to bottom",
                       legendgroup="Phase 1", legendgrouptitle_text="Phase 1"),
            row=1, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P1_3'].iloc[[-1]],
                       mode="lines+markers",
                       name="Discriminate shapes", legendgroup="Phase 1",
                       legendgrouptitle_text="Phase 1"),
            row=2, col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P1_4'],
                                 mode="lines+markers",
                                 name="Discriminate braille characters",
                                 legendgroup="Phase 1",
                                 legendgrouptitle_text="Phase 1"), row=2,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_1'],
                                 mode="lines+markers+text", name="Alphabet",
                                 legendgroup="Phase 2",
                                 legendgrouptitle_text="Phase 2",
                                 showlegend=True), row=1, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_1'].iloc[[-1]],
                       mode="text", text=[" G C L"],
                       textposition="middle right", legendgroup="Phase 2",
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_2'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_2'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_3'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_3'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_4'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_4'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_5'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_5'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_6'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_6'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_7'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_7'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_8'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_8'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_9'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_9'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_10'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_10'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_11'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_11'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_12'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_12'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_13'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_13'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_14'],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P2_14'].iloc[[-1]],
                       ...
                       legendgrouptitle_text="Phase 2",
                       showlegend=False), row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P2_15'],
        ...
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P3_14'],
                      ...
                      col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P3_15'],
                       mode="lines+markers", name="Shortform Words",
                       legendgroup="Phase 3d",
                       legendgrouptitle_text="Phase 3d"), row=5, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P4_1'],
                       mode="lines+markers", name="Grade 1 Indicators",
                       legendgroup="Phase 4", legendgrouptitle_text="Phase 4"),
            row=7, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P4_2'],
                       mode="lines+markers", name="Capitals Indicators",
                       legendgroup="Phase 4", legendgrouptitle_text="Phase 4"),
            row=7, col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P4_3'],
                                 mode="lines+markers",
                                 name="Numeric Mode and Spatial math",
                                 legendgroup="Phase 4",
                                 legendgrouptitle_text="Phase 4"), row=7,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P4_4'],
                                 mode="lines+markers",
                      ...
                      col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P5_1'],
                       mode="lines+markers", name="Page Numbering",
                       legendgroup="Phase 5", legendgrouptitle_text="Phase 5"),
            row=7, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P5_2'],
                                 mode="lines+markers", name="Headings",
                                 legendgroup="Phase 5",
                                 legendgrouptitle_text="Phase 5"), row=7,
                      col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P5_3'],
                                 mode="lines+markers", name="Lists",
                                 legendgroup="Phase 5",
                                 legendgrouptitle_text="Phase 5"), row=7,
                      col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P5_4'],
                                 mode="lines+markers", name="Poety / Drama",
                                 legendgroup="Phase 5",
                                 legendgrouptitle_text="Phase 5"), row=7,
                      col=2)
        fig.add_hrect(y0=-.5, y1=.5, line_width=0, fillcolor="red",
        ...
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P6_1'],
                                 mode="lines+markers",
                                 name=" Operation and Comparison Signs",
                                 legendgroup="Phase 6",
                                 legendgrouptitle_text="Phase 6"), row=1,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P6_2'],
                                 mode="lines+markers", name="Grade 1 Mode",
                                 legendgroup="Phase 6",
                                 legendgrouptitle_text="Phase 6"), row=1,
                      col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P6_3'],
                       mode="lines+markers", name="Special Print Symbols",
                       legendgroup="Phase 6", legendgrouptitle_text="Phase 6"),
            row=1, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P6_4'],
                       mode="lines+markers", name="Omission Marks",
                       legendgroup="Phase 6", legendgrouptitle_text="Phase 6"),
            row=1, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P6_5'],
                       mode="lines+markers", name="Shape Indicators",
                       legendgroup="Phase 6", legendgrouptitle_text="Phase 6"),
            row=1, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P6_6'],
                       mode="lines+markers", name="Roman Numerals",
                       legendgroup="Phase 6", legendgrouptitle_text="Phase 6"),
            row=1, col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P6_7'],
                                 mode="lines+markers", name="Fractions",
                                 legendgroup="Phase 6",
                                 legendgrouptitle_text="Phase 6"), row=1,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P7_1'],
                                 mode="lines+markers",
                                 name="Grade 1 Mode and Algebra",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=2,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P7_2'],
                                 mode="lines+markers",
                                 name="Grade 1 Mode and Fractions",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=2,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P7_3'],
                                 mode="lines+markers",
                                 name="Advanced Operation and Comparison Signs",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=2,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P7_4'],
                                 mode="lines+markers", name="Indices",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=2,
                      col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P7_5'],
                       mode="lines+markers", name="Roots and Radicals",
                       legendgroup="Phase 7", legendgrouptitle_text="Phase 7"),
            row=2, col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P7_6'],
                                 mode="lines+markers",
                                 name="Miscellaneous Shape Indicators",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=2,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P7_7'],
                                 mode="lines+markers", name="Functions",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=2,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P7_8'],
                                 mode="lines+markers", name="Greek letters",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=2,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P8_1'],
                                 mode="lines+markers", name="Functions",
                                 legendgroup="Phase 8",
                                 legendgrouptitle_text="Phase 8"), row=3,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P8_2'],
                                 mode="lines+markers",
                                 name="Modifiers, Bars, and Dots",
                                 legendgroup="Phase 8",
                                 legendgrouptitle_text="Phase 8"), row=3,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P8_3'],
                                 mode="lines+markers",
                                 name="Modifiers, Arrows, and Limits",
                                 legendgroup="Phase 8",
                                 legendgrouptitle_text="Phase 8"), row=3,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P8_4'],
                                 mode="lines+markers", name="Probability",
                                 legendgroup="Phase 8",
                                 legendgrouptitle_text="Phase 8"), row=3,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P8_5'],
                                 mode="lines+markers",
                      ...
                      col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy['P8_6'],
                       mode="lines+markers", name="Calculus: Integration",
                       legendgroup="Phase 8", legendgrouptitle_text="Phase 8"),
            row=3, col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy['P8_7'],
...
class screenreaderPanel(scrolled.ScrolledPanel):
    ...
    def save(self, event):
        ...
        def data_entry():
            ...
            c.execute(
                ...
                (studentname, dateNow, trial11, trial12, trial13, trial14,
                 trial15, trial16, trial21, trial22, trial23,
                 trial24, trial31, trial32, trial33, trial34, trial35, trial36,
    ...
    def graph(self, event):
        ...
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_1"],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_3"],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_5"],
                       mode="lines+markers", name="Access Documents",
                       legendgroup="Phase 1b", legendgrouptitle_text=" "),
            row=2, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_6"],
                       mode="lines+markers", name="Switch Program Focus",
                       legendgroup="Phase 1b", legendgrouptitle_text=" "),
            row=2, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P2_1"],
        ...
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P2_2"],
                                 ...
                                 legendgroup="Phase 2",
                                 legendgrouptitle_text="Phase 2"), row=1,
                      col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P2_3"],
                       mode="lines+markers", name="Write documents",
                       legendgroup="Phase 2", legendgrouptitle_text="Phase 2"),
            row=1, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P2_4"],
                       mode="lines+markers", name="Copy/Paste Text",
                       legendgroup="Phase 2", legendgrouptitle_text="Phase 2"),
            row=1, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P3_4"],
                       mode="lines+markers", name="TAB Navigation",
                       legendgroup="Phase 3a",
                       legendgrouptitle_text="Phase 3a"), row=3, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P3_5"],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P3_2"],
                       ...
                       legendgrouptitle_text="Phase 3b"), row=3, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P3_3"],
        ...
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P3_9"],
                      ...
                      col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P3_10"],
...
class abacusPanel(scrolled.ScrolledPanel):
    def __init__(self, parent):
        ...
        wx.StaticText(self, -1,
                      "3.3 Subtraction of Multiple Digit Numbers – Indirect",
                      pos=(30, 350))
        self.trial33 = wx.TextCtrl(self, -1, "", pos=(650, 350),
                                   size=(300, 20))
        wx.StaticText(self, -1,
                      "4.1 Multiplication – 2+ Digit Multiplicand, 1 Digit Multiplier",
                      pos=(30, 380))
        self.trial41 = wx.TextCtrl(self, -1, "", pos=(650, 380),
                                   size=(300, 20))
        wx.StaticText(self, -1,
                      "4.2 Multiplication – 2+ Digit Multiplicand AND Multiplier",
                      pos=(30, 410))
        self.trial42 = wx.TextCtrl(self, -1, "", pos=(650, 410),
                                   size=(300, 20))
        wx.StaticText(self, -1,
                      "5.1 Division – 2+ Digit Dividend, 1 Digit Divisor ",
                      pos=(30, 440))
        self.trial51 = wx.TextCtrl(self, -1, "", pos=(650, 440),
                                   size=(300, 20))
        wx.StaticText(self, -1,
                      "5.2 Division – 2+ Digit Dividend AND 1 Digit Divisor ",
                      pos=(30, 470))
        self.trial52 = wx.TextCtrl(self, -1, "", pos=(650, 470),
                                   size=(300, 20))
        wx.StaticText(self, -1, "6.1 Addition of Decimals", pos=(30, 500))
        self.trial61 = wx.TextCtrl(self, -1, "", pos=(650, 500),
                                   size=(300, 20))
        wx.StaticText(self, -1, "6.2 Subtraction of Decimals", pos=(30, 530))
        self.trial62 = wx.TextCtrl(self, -1, "", pos=(650, 530),
                                   size=(300, 20))
        wx.StaticText(self, -1, "6.3 Multiplication of Decimals",
                      pos=(30, 560))
        self.trial63 = wx.TextCtrl(self, -1, "", pos=(650, 560),
                                   size=(300, 20))
        wx.StaticText(self, -1, "6.4 Division of Decimals", pos=(30, 590))
        self.trial64 = wx.TextCtrl(self, -1, "", pos=(650, 590),
                                   size=(300, 20))
        wx.StaticText(self, -1, "7.1 Addition of Fractions", pos=(30, 620))
        self.trial71 = wx.TextCtrl(self, -1, "", pos=(650, 620),
                                   size=(300, 20))
        wx.StaticText(self, -1, "7.2 Subtraction of Fractions", pos=(30, 650))
        self.trial72 = wx.TextCtrl(self, -1, "", pos=(650, 650),
                                   size=(300, 20))
        wx.StaticText(self, -1, "7.3 Multiplication of Fractions",
                      pos=(30, 680))
        self.trial73 = wx.TextCtrl(self, -1, "", pos=(650, 680),
                                   size=(300, 20))
        wx.StaticText(self, -1, "7.4 Division of Fractions", pos=(30, 710))
        self.trial74 = wx.TextCtrl(self, -1, "", pos=(650, 710),
                                   size=(300, 20))
        wx.StaticText(self, -1, "8.1 Percent", pos=(30, 740))
        self.trial81 = wx.TextCtrl(self, -1, "", pos=(650, 740),
                                   size=(300, 20))
        wx.StaticText(self, -1, "8.2 Square Root", pos=(30, 770))
        self.trial82 = wx.TextCtrl(self, -1, "", pos=(650, 770),
                                   size=(300, 20))
    ...
    def save(self, event):
        ...
        def data_entry():
            ...
            c.execute(
                ...
                (studentname, dateNow, trial11, trial12, trial13, trial14,
                 trial21, trial22, trial23, trial31, trial32,
                 trial33, trial41, trial42, trial51, trial52, trial61, trial62,
    ...
    def graph(self, event):
        ...
        fig = make_subplots(rows=4, cols=2, subplot_titles=(
            "Phase 1: Foundation", "Phase 2: Addition", "Phase 3: Subtraction",
            "Phase 4: Multiplication",
            "Phase 5: Division", "Phase 6: Decimals", "Phase 7: Fractions",
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_2"],
                       ...
                       legendgroup="Phase 1", legendgrouptitle_text="Phase 1"),
            row=1, col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_3"],
                                 mode="lines+markers", name="Place Value",
                                 legendgroup="Phase 1",
                                 legendgrouptitle_text="Phase 1"), row=1,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_4"],
        ...
        fig.add_trace(
            ...
            row=1, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P2_2"],
                       mode="lines+markers", name="Clearing Beads",
                       legendgroup="Phase 2", legendgrouptitle_text="Phase 2"),
            row=1, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P2_3"],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P3_1"],
                       mode="lines+markers", name="Setting Numbers",
                       legendgroup="Phase 3", legendgrouptitle_text="Phase 3"),
            row=2, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P3_2"],
                       mode="lines+markers", name="Clearing Beads",
        ...
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P3_3"],
                                 mode="lines+markers", name="Place Value",
                                 legendgroup="Phase 3",
                                 legendgrouptitle_text="Phase 3"), row=2,
                      col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P4_1"],
                       mode="lines+markers", name="Setting Numbers",
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P4_2"],
                       ...
                       legendgroup="Phase 4", legendgrouptitle_text="Phase 4"),
            row=2, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P5_1"],
                                 mode="lines+markers", name="Place Value",
                                 legendgroup="Phase 5",
                                 legendgrouptitle_text="Phase 5"), row=3,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P5_2"],
                                 mode="lines+markers", name="Vocabulary",
                                 legendgroup="Phase 5",
                      ...
                      col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P6_1"],
                       mode="lines+markers", name="Setting Numbers",
                       legendgroup="Phase 6", legendgrouptitle_text="Phase 6"),
            row=3, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P6_2"],
                       mode="lines+markers", name="Clearing Beads",
                       legendgroup="Phase 6", legendgrouptitle_text="Phase 6"),
            row=3, col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P6_3"],
                                 mode="lines+markers", name="Place Value",
                                 legendgroup="Phase 6",
                                 legendgrouptitle_text="Phase 6"), row=3,
                      col=2)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P6_4"],
                                 mode="lines+markers", name="Vocabulary",
                                 legendgroup="Phase 6",
                                 legendgrouptitle_text="Phase 6"), row=3,
                      col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P7_1"],
                       mode="lines+markers", name="Setting Numbers",
                       legendgroup="Phase 7", legendgrouptitle_text="Phase 7"),
            row=4, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P7_2"],
                       mode="lines+markers", name="Clearing Beads",
                       legendgroup="Phase 7", legendgrouptitle_text="Phase 7"),
            row=4, col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P7_3"],
                                 mode="lines+markers", name="Place Value",
                                 legendgroup="Phase 7",
                                 legendgrouptitle_text="Phase 7"), row=4,
                      col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P7_4"],
                                 mode="lines+markers", name="Vocabulary",
                                 legendgroup="Phase 7",
                      ...
                      col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P8_1"],
                       mode="lines+markers", name="Setting Numbers",
                       legendgroup="Phase 8", legendgrouptitle_text="Phase 8"),
            row=4, col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P8_2"],
                       mode="lines+markers", name="Clearing Beads",
                       legendgroup="Phase 8", legendgrouptitle_text="Phase 8"),
            row=4, col=2)
        fig.add_hrect(y0=-.5, y1=.5, line_width=0, fillcolor="red",
...
class cviPanel(scrolled.ScrolledPanel):
    def __init__(self, parent):
        ...
        self.trial31 = wx.TextCtrl(self, -1, "", pos=(650, 290),
                                   size=(300, 20))
        wx.StaticText(self, -1, "Difficulty with Visual Novelty",
                      pos=(30, 320))
        self.trial32 = wx.TextCtrl(self, -1, "", pos=(650, 320),
                                   size=(300, 20))
    ...
    def graph(self, event):
        ...
        fig = make_subplots(rows=5, cols=2, subplot_titles=(
            ...
            "Nonpurposeful Gaze", "Distance Viewing", "Atypical Reflexes",
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_1"],
                       ...
                       legendgroup="", legendgrouptitle_text=" "), row=1,
            col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_2"],
        ...
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P1_3"],
                      ...
                      row=2, col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_4"],
                       mode="lines+markers", name="Field Prefence",
                       legendgroup="", legendgrouptitle_text=" "), row=2,
            col=2)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_5"],
                       mode="lines+markers", name="Visual Complexity",
                       legendgroup="", legendgrouptitle_text=" "), row=3,
            col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P1_6"],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P2_1"],
                       ...
                       legendgroup="", legendgrouptitle_text=" "), row=4,
            col=1)
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P2_2"],
        ...
        fig.add_trace(
            go.Scatter(x=df_noisy.index, y=df_noisy["P2_3"],
                       ...
                       legendgroup="", legendgrouptitle_text=" "), row=5,
            col=1)
        fig.add_trace(go.Scatter(x=df_noisy.index, y=df_noisy["P2_4"],
...
class meetingsPanel(scrolled.ScrolledPanel):
    def __init__(self, parent):
        ...
        self.notes1 = wx.TextCtrl(self, -1, "", pos=(170, 110),
