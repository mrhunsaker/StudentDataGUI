...
class braillePanel(scrolled.ScrolledPanel):
    ...
    def __init__(
        ...
        wx.StaticText(
                self,
                -1,
                "3.9 Lower Group/Wordsigns - EN IN",
                pos = (30,
                       890)
                )
...
class screenreaderPanel(scrolled.ScrolledPanel):
    ...
    def __init__(
        ...
        wx.StaticText(
                self,
                -1,
                "3.5 Navigate by “Quick Keys” (h for heading b for button and u for link) (METHOD 2)",
                pos = (30,
                       500)
                )
        self.trial35 = wx.TextCtrl(
...
class iepIntro(scrolled.ScrolledPanel):
    ...
    def submit(self, event):
        ...
        studentname = studentname.lower()
        addisonbbookeriep = """Addison Booker  	20 min / quarter
                    • When Addi is read a short story from a book with pictures, she will use eye gaze or touch to identify people or objects from the story or answer yes/no comprehension questions with 60% 
                    accuracy 2x 
                    weekly, across 3/5 data sessions.
                        ◦ When Addi is read a short story from a book with pictures, she will use eye gaze or touch to identify people or objects from the story or answer yes/no comprehension questions with 20% 
                        accuracy 
                        2x weekly, across 3/5 data sessions.
                        ◦ When Addi is read a short story from a book with pictures, she will use eye gaze or touch to identify people or objects from the story or answer yes/no comprehension questions with 40% 
                        accuracy 
                        2x weekly, across 3/5 data sessions.
                    """
        amiritoiep = """Ami Rito    20 min / month
        ...
        ashlynnenelsoniep = """Ashlynn Nelson  	20 min / month
                    • When given partial physical support, Ashylnn will be shown a selected musical instrument (xylophone, bells, drum, tambourine), and be shown a video (4-6ft away) of someone playing the selected 
                    musical instrument, then will focus her attention on the video for 3 seconds or more on 4/5 twice weekly trials, over 3 consecutive weeks.
                        ◦ When given partial physical support, Ashylnn will be shown a selected musical instrument (xylophone, bells, drum, tambourine), and be shown a video (4-6ft away) of someone playing the 
                        selected 
                        musical instrument, then will focus her attention on the video for 1 second on 4/5 twice weekly trials, over 3 consecutive weeks.
                        ◦ When given partial physical support, Ashylnn will be shown a selected musical instrument (xylophone, bells, drum, tambourine), and be shown a video (4-6ft away) of someone playing the 
                        selected 
        ...
        cartercostelloiep = """Carter Costello	    	120 min / month
                    • Carter will identify the braille letters of his name with 80% accuracy in 4/5 trials as measured by classroom data. (EE.RF.1.3)
                        ◦ Carter will identify 2/6 braille letters of his name with 80% accuracy in 4/5 trials as measured by classroom data.
                        ◦ Carter will identify 4/6 braille letters of his name with 80% accuracy in 4/5 trails as measured by classroom data.
                    • Carter will independently indicate the number that results when adding one more using manipulatives and/or the abacus with 80% accuracy in 4/5 trials as measured by classroom data. (
                    EE.1.OA.5.a)
                        ◦ With assistance from staff, Carter will indicate the number that results when adding one more using manipulatives or the abacus with 80% accuracy in 4/5 trials as measured by classroom data
                        ◦ Carter will independently identify the different parts of the abacus: the one beads, five beads and the reckoning bar with 80% accuracy unprompted in 4/5 trials as measured by classroom 
                        data.
                    • Carter will braille his name independently with 80% accuracy and no more than one prompt per probe on 5 probes as measured by classroom data. (EE.W.1.6)
                        ◦ Carter will independently learn to braille the letters in his name with 60% accuracy with less than 3 physical prompts as measured by classroom data.
                        ◦ Carter will use a braille writer to braille his name with limited physical assistance with 60% accuracy and no more than one prompt per probe on 5 probes as measured by classroom data.
        ...
        carstontalbotiep = """Carston Talbot  	30 min / month
                    ...
                    sessions 
                    as evidenced by vision and classroom data.
                        ◦ Carston will visually locate and chose the picture that represents the activity he would like with 4 out of 5 trials over 3 consecutive data sessions as evidenced by vision and classroom 
                        data.
                        ◦ Carston will visually locate and chose a picture that represents a preferred object that he would like with 4 out of 5 trials over 3 consecutive data sessions as evidenced by vision and 
                        classroom data.
                    """
        celestialneilsoniep = """Celestial  Nelson   	30 min / month
                    • Given the opportunity, in a variety of school-based locations, CD will, with minimal prompting, using her vision, make choices about academic and preferred activities within a class period in  
                    addition to 2 topics of conversation per location with a variety of people 70% of opportunities across 3 consecutive data session, as measured by classroom data and observation.
                        ◦ Given the opportunity, in a variety of school-based locations, CD will, with maximum prompting, using her vision, make choices about academic and preferred activities within a class 
                        period in 
                        addition to 1 topic of conversation per location with a variety of people 70% of opportunities across 3 consecutive data session, as measured by classroom data and observation.
                        ◦ Given the opportunity, in a variety of school-based locations, CD will, with maximum prompting, using her vision, make choices about academic and preferred activities within a class 
                        period in 
                    ...
                    """
        colecooperiep = """Cole  Cooper    30 min/month
                    • When presented with 2 objects, Cole will be able to utilize his central vision to locate an object with 70% accuracy as measured by the TVI and classroom teacher over 3 consecutive data 
                    sessions.
                        ◦ When presented with 2 objects, Cole will be able to utilize his central vision to locate an object with 50% accuracy as measured by the TVI and classroom teacher over 3 consecutive data 
                        sessions.
                        ◦ When presented with 2 objects, Cole will be able to utilize his central vision to locate an object with 60% accuracy as measured by the TVI and classroom teacher over 3 consecutive data 
                        sessions.
                    """
        diegopenalozadiaziep = """Dylan Penaloza-Diaz	    	40 min / month
                    • Dylan will independently complete eye-hand coordination matching activities and/or locating a specific letter, word, or icon on a communication board with 70% accuracy on by completing 4/5 
                    requests  
                    across 3 data sessions.
                        ◦ Dylan will independently complete eye-hand coordination matching activities and/or locating a specific letter, word, or icon on a communication board with 30% accuracy on by completing 
                        4/5  
                        requests across 3 data sessions.
                        ◦ Dylan will independently complete eye-hand coordination matching activities and/or locating a specific letter, word, or icon on a communication board with 50% accuracy on by completing 4/5 
                        requests across 3 data sessions.
                    """
        grantchristenseniep = """Grant Christensen	    	800 min/month
                    • Grant, through monthly assessments, will read braille at grade level text with a consistent speed of 65 cwpm with 95% accuracy or better with 100% comprehension in 4/5 trials as measured by 
                    his TVI.
                    • Grant, through monthly assessments, will produce complete sentences and passages using UEB contractions and proper braille writing techniques with 3 errors or less per writing assignment in 
                    4 of 5 
                    trials as measured by his TVI.
                    • Grant, through monthly assessments, will demonstrate proficiency in technology for the visually impaired with at least 95% accuracy on required tasks indicated on a checklist of skills from a 
                    Teacher's rubric in 3 of 4 evaluated sessions.
                    """
        kayleevimahiiep = """Kaylee Vimahi	    	60 min/month
                    • When given access to an accessible reading library, Kaylee will independently download 3 audio/eBooks and increase her reading speed and stamina from 143wpm and 10 minutes, 
                    to 200wpm and 30 minutes 
                    in 3 of 4 probes and measured by TVI created data sheets.
                    """
        madelinecostelloiep = """Madeline Costello	    	120 min / month
        ...
        noahpalmeriep = """Noah Palmer	    	20 min / month
                    ...
                    consecutive weeks.
                        ◦ Given verbal support, Noah will solve math money problems using the dollar more strategy for amounts up to $15.00 dollars using 1, 5 and 10 dollar bills, on 4/5 daily trials over 3 
                        consecutive 
                        weeks.
                        ◦ Given verbal support, Noah will solve math money problems using the dollar more strategy for amounts up to $17.00 dollars using 1, 5 and 10 dollar bills, on 4/5 daily trials over 3 
                        consecutive  
                        weeks.
                    """
        paulasackettiep = """
