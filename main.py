...
# HEADER
with ui.header().classes('text-white font-white font-bold row items-center bg-blue-950') as header:
...
with ui.tab_panels(tabs, value='ABACUS SKILLS'):
	with ui.tab_panel('ABACUS SKILLS'):
		...
		with ui.row().classes('w-1/2 no-wrap py-4'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="1.1", value="", on_change=lambda e: u_trial11.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="1.1 Setting Numbers"'
					).tooltip('1.1 Setting Numbers')
			ui.number(label="1.2", value="", on_change=lambda e: u_trial12.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="1.2 Clearing Numbers"'
					).tooltip('1.2 Clearing Numbers')
			ui.number(label="1.3", value="", on_change=lambda e: u_trial13.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="1.3 Place Value"'
					).tooltip('1.3 Place Value')
			ui.number(label="1.4", value="", on_change=lambda e: u_trial14.set_value(e.value)).classes('w-[100px]').props(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="2.1", value="", on_change=lambda e: u_trial21.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="2.1 Addition of Single Digit Numbers"'
					).tooltip(
					'2.1 Addition of Single Digit Numbers'
					)
			ui.number(label="2.2", value="", on_change=lambda e: u_trial22.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="2.2 Addition of Multiple Digit Numbers – Direct"'
					).tooltip(
					'2.2 Addition of Multiple Digit Numbers – Direct'
					)
			ui.number(label="2.3", value="", on_change=lambda e: u_trial23.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="2.3 Addition of Multiple Digit Numbers – Indirect"'
					).tooltip(
					'2.3 Addition of Multiple Digit Numbers – Indirect'
					)
			ui.label(' ').classes('w-[100px]')
		with ui.row().classes('w-screen no-wrap py-4'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="3.1", value="", on_change=lambda e: u_trial31.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="3.1 Subtraction"'
					).tooltip('3.1 Subtraction')
			ui.number(label="3.2", value="", on_change=lambda e: u_trial32.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="3.2 Subtraction of Multiple Digit Numbers – Direct"'
					).tooltip(
					'3.2 Subtraction of Multiple Digit Numbers – Direct'
					)
			ui.number(label="3.3", value="", on_change=lambda e: u_trial33.set_value(e.value)).classes('w-[100px]').props(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="4.1", value="", on_change=lambda e: u_trial41.set_value(e.value)).classes('w-[100px]').props(
			...
			ui.number(label="4.2", value="", on_change=lambda e: u_trial42.set_value(e.value)).classes('w-[100px]').props(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="5.1", value="", on_change=lambda e: u_trial51.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="5.1 Division – 2+ Digit Dividend 1-Digit Divisor"'
					).tooltip(
					'5.1 Division – 2+ Digit Dividend 1-Digit Divisor'
					)
			ui.number(label="5.2", value="", on_change=lambda e: u_trial52.set_value(e.value)).classes('w-[100px]').props(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="6.1", value="", on_change=lambda e: u_trial61.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="6.1 Addition of Decimals"'
					).tooltip('6.1 Addition of Decimals')
			ui.number(label="6.2", value="", on_change=lambda e: u_trial62.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="6.2 Subtraction of Decimals"'
					).tooltip('6.2 Subtraction of Decimals')
			ui.number(label="6.3", value="", on_change=lambda e: u_trial63.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="6.3 Multiplication of Decimals"'
					).tooltip('6.3 Multiplication of Decimals')
			ui.number(label="6.4", value="", on_change=lambda e: u_trial64.set_value(e.value)).classes('w-[100px]').props(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="7.1", value="", on_change=lambda e: u_trial71.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="7.1 Addition of Fractions"'
					).tooltip('7.1 Addition of Fractions')
			ui.number(label="7.2", value="", on_change=lambda e: u_trial72.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="7.2 Subtraction of Fractions"'
					).tooltip('7.2 Subtraction of Fractions')
			ui.number(label="7.3", value="", on_change=lambda e: u_trial73.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="7.3 Multiplication of Fractions"'
					).tooltip('7.3 Multiplication of Fractions')
			ui.number(label="7.4", value="", on_change=lambda e: u_trial74.set_value(e.value)).classes('w-[100px]').props(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(label="8.1", value="", on_change=lambda e: u_trial81.set_value(e.value)).classes('w-[100px]').props(
					'aria-label="8.1 Percent"'
					).tooltip('8.1 Percent')
			ui.number(label="8.2", value="", on_change=lambda e: u_trial82.set_value(e.value)).classes('w-[100px]').props(
	...
	with ui.tab_panel('BRAILLE SKILLS'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					...
					).classes('w-[100px]').props('aria-label="1.1 Track Left to Right"').tooltip(
					'1.1 Track Left to Right'
					)
			ui.number(
					label="1.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial12.set_value(e.value)
					).classes('w-[100px]').props('aria-label="1.2 Track Top to Bottom"')
			ui.number(
					label="1.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial13.set_value(e.value)
					).classes('w-[100px]').props('aria-label="1.3 Discriminate Shapes"')
			ui.number(
					label="1.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial14.set_value(e.value)
					).classes('w-[100px]').props('aria-label="1.4 Discriminate Braille Characters"')
			ui.label(' ').classes('w-[100px]')
		with ui.row().classes('w-screen no-wrap py-4'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					...
					).classes('w-[100px]').props('aria-label="2.1 Mangold Progression: G C L"')
			ui.number(
					label="2.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial22.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.2 Mangold Progression: D Y"')
			ui.number(
					label="2.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial23.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.3 Mangold Progression: A B"')
			ui.number(
					label="2.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial24.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.4 Mangold Progression: S"')
			ui.number(
					label="2.5", min=0, max=3, format='%.0f', on_change=lambda e: u_trial25.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.5 Mangold Progression: W"')
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="2.6", min=0, max=3, format='%.0f', on_change=lambda e: u_trial26.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.6 Mangold Progression: P O"')
			ui.number(
					label="2.7", min=0, max=3, format='%.0f', on_change=lambda e: u_trial27.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.7 Mangold Progression: K"')
			ui.number(
					label="2.8", min=0, max=3, format='%.0f', on_change=lambda e: u_trial28.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.8 Mangold Progression: R"')
			ui.number(
					label="2.9", min=0, max=3, format='%.0f', on_change=lambda e: u_trial29.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.9 Mangold Progression: M E"')
			ui.number(
					label="2.10", min=0, max=3, format='%.0f', on_change=lambda e: u_trial210.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.10 Mangold Progression: H"')
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="2.11", min=0, max=3, format='%.0f', on_change=lambda e: u_trial211.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.11 Mangold Progression: N X"')
			ui.number(
					label="2.12", min=0, max=3, format='%.0f', on_change=lambda e: u_trial212.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.12 Mangold Progression: Z F"')
			ui.number(
					label="2.13", min=0, max=3, format='%.0f', on_change=lambda e: u_trial213.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.13 Mangold Progression: U T"')
			ui.number(
					label="2.14", min=0, max=3, format='%.0f', on_change=lambda e: u_trial214.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.14 Mangold Progression: Q I"')
			ui.number(
					label="2.15", min=0, max=3, format='%.0f', on_change=lambda e: u_trial215.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.15 Mangold Progression: V J"')
		with ui.row().classes('w-screen no-wrap py-4'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					...
					).classes('w-[100px]').props('aria-label="3.1 Alphabetic Wordsigns"')
			ui.number(
					label="3.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial32.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.2 Braille Numbers"')
			ui.number(
					label="3.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial33.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.3 Punctuation"')
			ui.number(
					label="3.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial34.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.4 Strong Contractions - AND OF FOR WITH THE"')
			ui.number(
					label="3.5", min=0, max=3, format='%.0f', on_change=lambda e: u_trial35.set_value(e.value)
					).classes('w-[100px]').props(
					'aria-label="3.5 Strong Groupsigns - CH GH SH TH WH ED ER OU OW ST AR ING"'
					)
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="3.6", min=0, max=3, format='%.0f', on_change=lambda e: u_trial36.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.6 Strong Wordsigns - CH SH TH WH OU ST"')
			ui.number(
					label="3.7", min=0, max=3, format='%.0f', on_change=lambda e: u_trial37.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.7 Lower Groupsigns - BE CON DIS"')
			ui.number(
					label="3.8", min=0, max=3, format='%.0f', on_change=lambda e: u_trial38.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.8 Lower Groupsigns - EA BB CC FF GG"')
			ui.number(
					label="3.9", min=0, max=3, format='%.0f', on_change=lambda e: u_trial39.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.9 Lower Group/Wordsigns - EN IN"')
			ui.number(
					label="3.10", min=0, max=3, format='%.0f', on_change=lambda e: u_trial310.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.10 Lower Wordsigns - BE HIS WAS WERE"').tooltip(
					'3.10 Lower Wordsigns - BE HIS WAS WERE'
					)
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="3.11", min=0, max=3, format='%.0f', on_change=lambda e: u_trial311.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.11 Dot 5 Contractions"').tooltip(
					'3.11 Dot 5 Contractions'
					)
			ui.number(
					label="3.12", min=0, max=3, format='%.0f', on_change=lambda e: u_trial312.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.12 Dot 45 Contractions"').tooltip(
					'3.12 Dot 45 Contractions'
					)
			ui.number(
					label="3.13", min=0, max=3, format='%.0f', on_change=lambda e: u_trial313.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.13 Dot 456 Contractions"').tooltip(
					'3.13 Dot 456 Contractions'
					)
			ui.number(
					label="3.14", min=0, max=3, format='%.0f', on_change=lambda e: u_trial314.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.14 Final Letter Groupsigns"').tooltip(
					'3.14 Final Letter Groupsigns'
					)
			ui.number(
					label="3.15", min=0, max=3, format='%.0f', on_change=lambda e: u_trial315.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.15 Shortform Words"').tooltip(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					...
					).classes('w-[100px]').props('aria-label="4.1 Grade 1 Indicators"').tooltip(
					'4.1 Grade 1 Indicators'
					)
			ui.number(
					label="4.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial42.set_value(e.value)
					).classes('w-[100px]').props('aria-label="4.2 Capitals Indicators"').tooltip(
					'4.2 Capitals Indicators'
					)
			ui.number(
					label="4.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial43.set_value(e.value)
					).classes('w-[100px]').props('aria-label="4.3 Numeric Mode and Spatial Math"').tooltip(
					'4.3 Numeric Mode and Spatial Math'
					)
			ui.number(
					label="4.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial44.set_value(e.value)
					).classes('w-[100px]').props(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					...
					).classes('w-[100px]').props('aria-label="5.1 Page Numbering"').tooltip('5.1 Page Numbering')
			ui.number(
					label="5.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial52.set_value(e.value)
					).classes('w-[100px]').props('aria-label="5.2 Headings"').tooltip('5.2 Headings')
			ui.number(
					label="5.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial53.set_value(e.value)
					).classes('w-[100px]').props('aria-label="5.3 Lists"').tooltip('5.3 Lists')
			ui.number(
					label="5.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial54.set_value(e.value)
					).classes('w-[100px]').props('aria-label="5.4 Poetry / Drama"').tooltip('5.4 Poetry / Drama')
			ui.label(' ').classes('w-[100px]')
		with ui.row().classes('w-screen no-wrap py-4'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					...
					).classes('w-[100px]').props('aria-label="6.1 Operation and Comparison Signs"').tooltip(
					'6.1 Operation and Comparison Signs'
					)
			ui.number(
					label="6.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial62.set_value(e.value)
					).classes('w-[100px]').props('aria-label="6.2 Grade 1 Mode"').tooltip('6.2 Grade 1 Mode')
			ui.number(
					label="6.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial63.set_value(e.value)
					).classes('w-[100px]').props('aria-label="6.3 Special Print Symbols"').tooltip(
					'6.3 Special Print Symbols'
					)
			ui.number(
					label="6.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial64.set_value(e.value)
					).classes('w-[100px]').props('aria-label="6.4 Omission Marks"').tooltip('6.4 Omission Marks')
			ui.number(
					label="6.5", min=0, max=3, format='%.0f', on_change=lambda e: u_trial65.set_value(e.value)
					).classes('w-[100px]').props('aria-label="6.5 Shape Indicators"').tooltip('6.5 Shape Indicators')
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="6.6", min=0, max=3, format='%.0f', on_change=lambda e: u_trial66.set_value(e.value)
					).classes('w-[100px]').props('aria-label="6.6 Roman Numerals"').tooltip('6.6 Roman Numerals')
			ui.number(
					label="6.7", min=0, max=3, format='%.0f', on_change=lambda e: u_trial67.set_value(e.value)
					).classes('w-[100px]').props('aria-label="6.7 Fractions"').tooltip('6.7 Fractions')
			ui.label(' ').classes('w-[100px]')
			ui.label(' ').classes(' w-[100px]')
			ui.label(' ').classes('w-[100px]')
		with ui.row().classes('w-screen no-wrap py-4'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					...
					).classes('w-[100px]').props('aria-label="7.1 Grade 1 Mode and algebra"').tooltip(
					'7.1 Grade 1 Mode and algebra'
					)
			ui.number(
					label="7.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial72.set_value(e.value)
					).classes('w-[100px]').props('aria-label="7.2 Grade 1 Mode and Fractions"').tooltip(
					'7.2 Grade 1 Mode and Fractions'
					)
			ui.number(
					label="7.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial73.set_value(e.value)
					).classes('w-[100px]').props('aria-label="7.3 Advanced Operation and Comparison Signs"').tooltip(
					'7.3 Advanced Operation and Comparison Signs'
					)
			ui.number(
					label="7.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial74.set_value(e.value)
					).classes('w-[100px]').props('aria-label="7.4 Indices"').tooltip('7.4 Indices')
			ui.number(
					label="7.5", min=0, max=3, format='%.0f', on_change=lambda e: u_trial75.set_value(e.value)
					).classes('w-[100px]').props('aria-label="7.5 Roots and Radicals"').tooltip(
					'7.5 Roots and Radicals'
					)
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="7.6", min=0, max=3, format='%.0f', on_change=lambda e: u_trial76.set_value(e.value)
					).classes('w-[100px]').props('aria-label="7.6 Miscellaneous Shape Indicators"').tooltip(
					'7.6 Miscellaneous Shape Indicators'
					)
			ui.number(
					label="7.7", min=0, max=3, format='%.0f', on_change=lambda e: u_trial77.set_value(e.value)
					).classes('w-[100px]').props('aria-label="7.7 Functions"').tooltip('7.7 Functions')
			ui.number(
					label="7.8", min=0, max=3, format='%.0f', on_change=lambda e: u_trial78.set_value(e.value)
					).classes('w-[100px]').props('aria-label="7.8 Greek Letters"').tooltip('7.8 Greek Letters')
			ui.label(' ').classes('w-[100px]')
			ui.label(' ').classes('w-[100px]')
		with ui.row().classes('w-screen no-wrap py-4'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="8.1", min=0, max=3, format='%.0f', on_change=lambda e: u_trial81.set_value(e.value)
					).classes('w-[100px]').props('aria-label="8.1 Functions"')
			ui.number(
					label="8.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial82.set_value(e.value)
					).classes('w-[100px]').props('aria-label="8.2 Modifiers: Bars and Dots"').tooltip(
					'8.2 Modifiers: Bars and Dots'
					)
			ui.number(
					label="8.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial83.set_value(e.value)
					).classes('w-[100px]').props('aria-label="8.3 Modifiers: Arrows and Limits"').tooltip(
					'8.3 Modifiers: Arrows and Limits'
					)
			ui.number(
					label="8.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial84.set_value(e.value)
					).classes('w-[100px]').props('aria-label="8.4 Probability"').tooltip('8.4 Probability')
			ui.number(
					label="8.5", min=0, max=3, format='%.0f', on_change=lambda e: u_trial85.set_value(e.value)
					).classes('w-[100px]').props('aria-label="8.5 Calculus: Differentiation"').tooltip(
					'8.5 Calculus: Differentiation'
					)
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="8.6", min=0, max=3, format='%.0f', on_change=lambda e: u_trial86.set_value(e.value)
					).classes('w-[100px]').props('aria-label="8.6 Calculus: Integration"').tooltip(
					'8.6 Calculus: Integration'
					)
			ui.number(
					label="8.7", min=0, max=3, format='%.0f', on_change=lambda e: u_trial87.set_value(e.value)
					).classes('w-[100px]').props('aria-label="8.7 Vertical Bars"').tooltip('8.7 Vertical Bars')
			ui.label(' ').classes('w-[100px]')
			ui.label(' ').classes('w-[100px]')
			ui.label(' ').classes('w-[100px]')
		with ui.row().classes('w-screen no-wrap py-4'):
...
with ui.tab_panels(tabs, value='SCREENREADER SKILLS'):
	with ui.tab_panel('SCREENREADER SKILLS'):
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="1.1", min=0, max=3, format='%.0f', on_change=lambda e: u_trial11.set_value(e.value)
					).classes('w-[100px]').props('aria-label="1.1 Turn on and off the screen reader"').tooltip(
			...
			ui.number(
					label='1.5', min=0, max=3, format='%.0f', on_change=lambda e: u_trial15.set_value(e.value)
					).classes('w-[100px]').props(
			...
			ui.number(
					label='1.6', min=0, max=3, format='%.0f', on_change=lambda e: u_trial16.set_value(e.value)
					).classes('w-[100px]').props('aria-label="1.6 Switch Program Focus"').tooltip(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			...
			ui.number(
					label="2.4", min=0, max=3, format='%.0f', on_change=lambda e: u_trial24.set_value(e.value)
					).classes('w-[100px]').props('aria-label="2.4. Select copy and paste text"').tooltip(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			...
			ui.number(
					label="3.2", min=0, max=3, format='%.0f', on_change=lambda e: u_trial32.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.2 identify each element by type."').tooltip(
					'3.2 identify each element by type.'
					)
			ui.number(
					label="3.3", min=0, max=3, format='%.0f', on_change=lambda e: u_trial33.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.3 navigate to the address bar"').tooltip(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			ui.number(
					label="3.8", min=0, max=3, format='%.0f', on_change=lambda e: u_trial38.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.8 Switch tab focus"').tooltip('3.8 Switch tab focus')
			ui.number(
					label="3.9", min=0, max=3, format='%.0f', on_change=lambda e: u_trial39.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.9 Switch between screen reader modes"').tooltip(
					'3.9 Switch between screen reader modes'
					)
			ui.number(
					label="3.10", min=0, max=3, format='%.0f', on_change=lambda e: u_trial310.set_value(e.value)
					).classes('w-[100px]').props('aria-label="3.10 Navigate a table"').tooltip(
		...
		with ui.row().classes('w-screen no-wrap py-4'):
			...
			ui.number(
					label="4.5", min=0, max=3, format='%.0f', on_change=lambda e: u_trial45.set_value(e.value)
					).classes('w-[100px]').props('aria-label="4.5 Extract zipped folders"').tooltip(
					'4.5 Extract zipped folders'
					)
			ui.number(
					label="4.6", min=0, max=3, format='%.0f', on_change=lambda e: u_trial46.set_value(e.value)
					).classes('w-[100px]').props(
					'aria-label="4.6 Utilize the virtual cursor and mouse keys"'
					).tooltip('4.6 Utilize the virtual cursor and mouse keys')
			ui.number(
					label="4.7", min=0, max=3, format='%.0f', on_change=lambda e: u_trial47.set_value(e.value)
					).classes('w-[100px]').props(
...
with ui.footer(value=True).classes('bg-blue-950') as footer:
	with ui.row().classes('w-screen no-wrap text-l font-bold justify-center items-center'):
		ui.label('Copyright © 2023 Michael Ryan Hunsaker, M.Ed., Ph.D.').classes('justify-center items-center')
	with ui.row().classes('w-screen no-wraptext-l font-bold justify-center items-center text-white'):
		ui.label('Email hunsakerconsulting@gmail.com to Report Bugs or Request Features').classes(
				'justify-center items-center text-white'
				)
# SIDEBAR
with ui.left_drawer(value=True).classes('bg-blue-950 text-white') as left_drawer:
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.label('MATERIALS').classes('w-full no-wrap py-4 text-white font-bold text-xljustify-center items-center')
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.label('ABACUS').classes('w-full no-wrap py-4 font-bold text-white text-xljustify-center items-center')
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Hadley Abacus Curriculum I', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/Abacus1.pdf', new_tab=True).classes(
				'text-left w-full align-left font-bold text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Hadley Abacus Curriculum II', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/Abacus2.pdf', new_tab=True).classes(
				'text-left w-full align-left font-bold text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Abacus Made Easy', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/AbacusMadeEasy.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Using the Cranmer Abacus', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/UsingCranmerAbacus.pdf', new_tab=True
				).classes(
				'text-left w-full align-left  font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Japanese Abacus Use and Theory', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/abacusUseTheory.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Advanced Japanese Abacus', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/AdvancedAbacus.pdf', new_tab=True
				).classes(
				'text-left w-full align-left  font-bold text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.label('BRAILLE').classes('w-screen no-wrap py-4 font-bold text-white text-xl justify-center items-center')
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'NLS-IMBT UEB Literary Braille', '', new_tab=True
				).classes('text-left w-full align-left font-bold  text-white')
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'UEB Australian Training Manual', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/UEBAustralianTrainingManual.pdf', new_tab=True
				).classes(
				'text-left w-full align-left  font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'UEB Technical Course', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/UEBTechnicalCourse.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'UEB Technical Guidelines', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/UEBTechnicalGuidelines.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'UEB with Nemeth', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/NemethUEBContext.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.label('SCREENREADER').classes('w-screen no-wrap py-4 font-bold text-white text-xl justify-center items-center')
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'NVDA Trainings','https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/NVDATrainings.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Windows Screen Reader Primer', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/WindowsScreenreaderPrimer.zip', new_tab=True
				).classes(
				'text-left w-full align-left  font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Getting Started with Windows 11', 'https://github.com/mrhunsaker/Materials/raw/main/instructionMaterials/GettingStartedWindows11.doc', new_tab=True
				).classes(
				'text-left w-full align-left font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.label('DATASHEETS').classes('w-screen no-wrap py-4 content-center font-bold text-white text-xl justify-center items-center')
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Blank Vision Template', 'https://github.com/mrhunsaker/Materials/raw/main/datasheets/BlankVisionTemplate.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Generic Data Sheets', 'https://github.com/mrhunsaker/Materials/raw/main/datasheets/GenericDataSheets.pdf', new_tab=True
				).classes(
				'text-left w-full align-left  font-bold  text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Bi-Weekly Progress Monitoring', 'https://github.com/mrhunsaker/Materials/raw/main/datasheets/ProgressMonitoring.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold text-white'
				)
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
	...
	with ui.row().classes('w-full no-wrap text-l font-bold justify-center items-center'):
		ui.link(
				'Educational Vision Evaluation Forms', 'https://github.com/mrhunsaker/Materials/raw/main/visionAssessments/EducationVisionAssessments.pdf', new_tab=True
				).classes(
				'text-left w-full align-left font-bold text-white')
