...
ECC_CareerEducation = [
    ...
    'Listen and attend to others', 'Follow directions',
    'Stay on task',
    'Complete tasks',
        ...
        if box.ShowModal() == wx.ID_OK:
            ...
            if not os.path.exists(
                ...
                self.filename.write(
                    f"{USER_DIR}\\StudentDatabase\\StudentDataFiles\\{studentname}\\{self.studentdatabasename}.txt" + '\n')
                self.filename.close()
                list_names = ['date', 'P1_1', 'P1_2', 'P1_3', 'P1_4', 'P1_5', 'P1_6', 'P2_1', 'P2_2', 'P2_3', 'P2_4', 'P3_1', 'P3_2', 'P3_3', 'P3_4', 'P3_5', 'P3_6', 'P3_7', 'P3_8', 'P3_9', 'P3_10', 'P3_11', 'P4_1',
                              'P4_2', 'P4_3', 'P4_4', 'P4_5', 'P4_6', 'P4_7']
                list_data = [
                    dateNow,
                    trial11,
                    trial12,
