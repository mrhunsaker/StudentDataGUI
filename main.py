...
ECC_CareerEducation = [
    ...
    'Career preparation: reading and understanding want ads, recognizing typical job adaptations make by workers with visual impairments, developing prevocationals skills (such as work habits, attitudes, '
    'and motivation), and having vocational interests',
...
class dataPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.btn2 = wx.Button(
            self, 203, "Check IEP Goals", pos = (135, 850),
            size = (150, 30)
            )
    ...
    def save(self, event):
        ...
        if (len(studentname) and len(date) and len(task) and len(notes)) > 0:
            ...
            if box.ShowModal() == wx.ID_OK:
                ...
                self.dial = wx.MessageDialog(
                    None, 'Save cancelled', 'Info',
                    wx.OK
                    )
                self.dial.ShowModal()
        else:
            self.dial = wx.MessageDialog(
                None, 'Fill Required Fields!', 'Info',
                wx.OK
                )
            self.dial.ShowModal()
...
class braillePanel(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent):
        ...
        wx.StaticText(
            self, -1, "1.4 Discriminate Braille Characters",
            pos = (30, 170)
            )
        ...
        wx.StaticText(
            self, -1, "2.1 Mangold Progression: G C L",
            pos = (30, 200)
            )
        ...
        wx.StaticText(
            self, -1, "3.6 Strong Wordsigns - CH SH TH WH OU ST",
            pos = (30, 800)
            )
        ...
        wx.StaticText(
            self, -1, "3.7 Lower Groupsigns - BE CON DIS",
            pos = (30, 830)
            )
        ...
        wx.StaticText(
            self, -1, "3.8 Lower Groupsigns - EA BB CC FF GG",
            pos = (30, 860)
            )
        ...
        wx.StaticText(
            self, -1, "3.9 Lower Group/Wordsigns - EN IN",
            pos = (30, 890)
            )
        ...
        wx.StaticText(
            self, -1, "3.10 Lower Wordsigns - BE HIS WAS WERE",
            pos = (30, 920)
            )
        ...
        wx.StaticText(
            self, -1, "4.3 Numeric Mode and Spatial Math",
            pos = (30, 1160)
            )
        ...
        wx.StaticText(
            self, -1, "6.1 Operation and Comparison Signs",
            pos = (30, 1340)
            )
        ...
        wx.StaticText(
            self, -1, "7.2 Grade 1 Mode and Fractions",
            pos = (30, 1580)
            )
        ...
        wx.StaticText(
            self, -1, "7.3 Advanced Operation and Comparison Signs",
            pos = (30, 1610)
            )
        ...
        wx.StaticText(
            self, -1, "7.6 Miscellaneous Shape Indicators",
            pos = (30, 1700)
            )
        ...
        wx.StaticText(
            self, -1, "8.2 Modifiers, Bars, and Dots",
            pos = (30, 1820)
            )
        ...
        wx.StaticText(
            self, -1, "8.3 Modifiers, Arrows, and Limits",
            pos = (30, 1850)
            )
        ...
        wx.StaticText(
            self, -1, "8.5 Calculus: Differentiation",
            pos = (30, 1910)
            )
        ...
        self.Bind(wx.EVT_BUTTON, self.save, id = 201)
        self.btn = wx.Button(
            self, 203, "PRINT GRAPHS", pos = (450, 2040),
            size = (170, 30)
            )
        self.Bind(wx.EVT_BUTTON, self.graph, id = 203)
        self.btn1 = wx.Button(
            self, 202, "EXIT", pos = (550, 2000),
            size = (70, 30)
            )
        self.Bind(wx.EVT_BUTTON, self.exit, id = 202)
    ...
    def graph(self, event):
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P1_3'].iloc[[-1]],
                mode = "lines+markers",
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_1'].iloc[[-1]],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_2'].iloc[[-1]],
                mode = "text", text = [" D Y"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_3'].iloc[[-1]],
                mode = "text", text = [" A B"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_4'].iloc[[-1]],
                mode = "text", text = [" S"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_5'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_5'].iloc[[-1]],
                mode = "text", text = [" W"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_6'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_6'].iloc[[-1]],
                mode = "text", text = [" P O"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_7'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_7'].iloc[[-1]],
                mode = "text", text = [" K"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_8'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_8'].iloc[[-1]],
                mode = "text", text = [" R"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_9'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_9'].iloc[[-1]],
                mode = "text", text = [" M E"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_10'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_10'].iloc[[-1]],
                mode = "text", text = [" H"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_11'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_11'].iloc[[-1]],
                mode = "text", text = [" N X"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_12'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_12'].iloc[[-1]],
                mode = "text", text = [" Z F"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_13'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_13'].iloc[[-1]],
                mode = "text", text = [" U T"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_14'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_14'].iloc[[-1]],
                mode = "text", text = [" Q I"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_15'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P2_15'].iloc[[-1]],
                mode = "text", text = [" V J"],
                textposition = "middle right", legendgroup = "Phase 2",
                legendgrouptitle_text = "Phase 2",
                showlegend = False
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P3_12'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P3_13'],
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P3_14'],
                mode = "lines+markers",
        ...
        fig.add_trace(
            go.Scatter(
                x = df_noisy.index, y = df_noisy['P3_15'],
        ...
        fig.add_hrect(
            y0 = -.5, y1 = .5, line_width = 0, fillcolor = "red",
            opacity = 0.2, row = 1, col = 1
            )
        fig.add_hrect(
            y0 = .5, y1 = 1.5, line_width = 0, fillcolor = "orange",
            opacity = 0.2, row = 1, col = 1
            )
        fig.add_hrect(
            y0 = 1.5, y1 = 2.5, line_width = 0, fillcolor = "yellow",
            opacity = 0.2, row = 1, col = 1
            )
        fig.add_hrect(
            y0 = 2.5, y1 = 3.5, line_width = 0, fillcolor = "green",
            opacity = 0.2, row = 1, col = 1
            )
        fig.add_hrect(
            y0 = -.5, y1 = .5, line_width = 0, fillcolor = "red",
...
class screenreaderPanel(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent):
        ...
        self.SetFont(wx.Font(wx.FontInfo(8)))
        wx.StaticText(
            self, -1, "SCREENREADER SKILLS PROGRESSION",
            pos = (200, 20)
            )
        wx.StaticText(self, -1, "Student Name", pos = (30, 50))
        self.studentname1 = wx.Choice(
        ...
        wx.StaticText(
            self, -1, "1.1 Turn on and off the screen reader",
            pos = (30, 80)
            )
        self.trial11 = wx.TextCtrl(self, -1, "", pos = (650, 80), size = (300, 20))
        wx.StaticText(
        ...
        wx.StaticText(
            self, -1, "2.4. Select, copy and paste text.",
            pos = (30, 350)
            )
        self.trial24 = wx.TextCtrl(
            self, -1, "", pos = (650, 350),
        ...
        wx.StaticText(
            self, -1, "3.2 identify each element by type.",
            pos = (30, 410)
            )
        self.trial32 = wx.TextCtrl(
            self, -1, "", pos = (650, 410),
        ...
        wx.StaticText(
            self, -1, "3.3 navigate to the address bar",
            pos = (30, 440)
            )
        self.trial33 = wx.TextCtrl(
            self, -1, "", pos = (650, 440),
        ...
        self.Bind(wx.EVT_BUTTON, self.save, id = 201)
        self.btn = wx.Button(
            self, 203, "PRINT GRAPHS", pos = (450, 970),
            size = (170, 30)
            )
        self.Bind(wx.EVT_BUTTON, self.graph, id = 203)
...
class abacusPanel(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent):
        ...
        wx.StaticText(
            self, -1, "2.1 Addition of Single Digit Numbers",
            pos = (30, 200)
            )
        self.trial21 = wx.TextCtrl(
            self, -1, "", pos = (650, 200),
        ...
        wx.StaticText(
            self, -1, "6.3 Multiplication of Decimals",
            pos = (30, 560)
            )
        self.trial63 = wx.TextCtrl(
            self, -1, "", pos = (650, 560),
        ...
        wx.StaticText(
            self, -1, "7.3 Multiplication of Fractions",
            pos = (30, 680)
            )
        self.trial73 = wx.TextCtrl(
            self, -1, "", pos = (650, 680),
        ...
        self.Bind(wx.EVT_BUTTON, self.save, id = 201)
        self.btn = wx.Button(
            self, 203, "PRINT GRAPHS", pos = (450, 870),
            size = (170, 30)
            )
        self.Bind(wx.EVT_BUTTON, self.graph, id = 203)
...
class cviPanel(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent):
        ...
        wx.StaticText(
            self, -1, "Difficulty with Visual Complexity",
            pos = (30, 200)
            )
        self.trial21 = wx.TextCtrl(
            self, -1, "", pos = (650, 200),
        ...
        wx.StaticText(
            self, -1, "Light Gazing and Nonpurposeful Gaze",
            pos = (30, 230)
            )
        self.trial22 = wx.TextCtrl(
            self, -1, "", pos = (650, 230),
        ...
        wx.StaticText(
            self, -1, "Difficulty with Distance Viewing",
            pos = (30, 260)
            )
        self.trial23 = wx.TextCtrl(
            self, -1, "", pos = (650, 260),
        ...
        wx.StaticText(
            self, -1, "Difficulty with Visual Novelty",
            pos = (30, 320)
            )
        self.trial32 = wx.TextCtrl(
            self, -1, "", pos = (650, 320),
        ...
        wx.StaticText(
            self, -1, "Absence of Visually Guided Reach",
            pos = (30, 350)
            )
        self.trial33 = wx.TextCtrl(
            self, -1, "", pos = (650, 350),
        ...
        self.Bind(wx.EVT_BUTTON, self.save, id = 201)
        self.btn2 = wx.Button(
            self, 203, "PRINT GRAPHS", pos = (400, 450),
            size = (170, 30)
            )
        self.Bind(wx.EVT_BUTTON, self.graph, id = 203)
        ...
        self.btn3 = wx.Button(
            self, 204, "SHOW RUBRIC", pos = (30, 550),
            size = (170, 30)
            )
...
class iepIntro(scrolled.ScrolledPanel):
    ...
    def submit(self, event):
        ...
        AddisonBookerIEP = """Addison Booker  	20 min / quarter
             • When Addi is read a short story
            with pictures, she will use eye gaze or touch to identify people or objects from the story or answer yes/no comprehension questions with 60% accuracy 2x weekly, across 3/5 data sessions.
                 ◦ When Addi is read a short story from a book with pictures, she will use eye gaze or touch to identify people or objects from the story or answer yes/no comprehension questions with 20% accuracy 
                 2x weekly, across 3/5 data sessions.
                 ◦ When Addi is read a short story from a book with pictures, she will use eye gaze or touch to identify people or objects from the story or answer yes/no comprehension questions with 40% accuracy 
                 2x weekly, across 3/5 data sessions.
        ...
        CarterCostelloIEP = """Carter Costello	    	120 min / month
             ...
             """
        CarstonTalbotIEP = """Carston Talbot  	30 min / month
             • When given a choice between two pictures, Carston will visually locate and chose the picture that represents the object/activity he would like with 4 out of 5 trials over 3 consecutive data 
             sessions as evidenced by vision and classroom data.
                 ◦ Carston will visually locate and chose the picture that represents the activity he would like with 4 out of 5 trials over 3 consecutive data sessions as evidenced by vision and classroom data.
                 ◦ Carston will visually locate and chose a picture that represents a preferred object that he would like with 4 out of 5 trials over 3 consecutive data sessions as evidenced by vision and 
                 classroom data.
             """
        ...
        MadelineCostelloIEP = """Madeline Costello	    	120 min / month
             • When given 2 sets of textured items, Maddie will identify same and different by separating all the same items into a box with 80% accuracy in 4/5 trials as measured by classroom data. (EE.4.MD.6)
                 ◦ When given 2 sets of textured items, Maddie will identify the set that is either the same or different with 60% accuracy in 4/5 trials as measured by classroom data.
                 ◦ When given 2 sets of textured items, Maddie will identify the set that is either the same or different with 70% accuracy in 4/5 trials as measured by classroom data.
             • When read a story by an adult, Maddie will determine the meaning of words in text by identifying the object or tactile drawing that goes with the story with 70% accuracy in 4/5 trials as measured 
             by classroom data. (EE.RL.4.4)
                 ◦ When given an actual object, Maddie will be able to identify the tactile drawing version of the object with 70% accuracy in 4/5 trials as measured by classroom data.
                 ◦ When given an actual object, Maddie will be able to identify the tactile drawing version of the object with 60% accuracy in 4/5 trials as measured by classroom data.
             • With guidance and support, Maddie will use the braille writer to braille her name with 80% accuracy in 4/5 trials as measured by classroom data. (EE.W.4.6)
                 ◦ When presented with a braille swing cell, Maddie independently will learn cell placement (1, 2,3, 4,5, 6) with 40% accuracy in 4/5 trials as measured by classroom data. (EE.W.4.6)
...
class meetingsPanel(scrolled.ScrolledPanel):
    ...
    def __init__(self, parent):
        ...
        self.Bind(wx.EVT_BUTTON, self.save, id = 201)
        self.btn2 = wx.Button(
            self, 203, "UPLOAD FILE", pos = (450, 890),
            size = (170, 30)
            )
