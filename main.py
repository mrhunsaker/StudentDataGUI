...
##############################################################################
students = ['ColeCooper', 'LandonGraham', 'TarelLewis', 'DynPenalozaDiaz', 'CarterCostello', 'MadelineCostello',
            'SuttonBuell', 'MargaretWalker', 'TysonGraham', 'AddisonBooker', 'AmiRito', 'AshlynneNelson',
            'CarstonTalbot', 'CelestialNeilson', 'LanedonLee', 'NoahPalmer', 'PaulaSackett']

students_all = ['AddisonBooker', 'AlaijahValdez', 'AlessaPurcel', 'AlexRoylance', 'AmiRito', 'AmmonOlsen',
                'AshlynnNelson', 'AustinDenney', 'AvaWilson', 'BaraahAlArbid', 'BelleOsborn', 'BrightonTingey',
                'BryceClark', 'CallumDavis', 'CarstonTalbot', 'CarterCostello', 'CasonHemphill', 'CelestialNeilson',
                'CharlieChristensen', 'ChaseCreer', 'ChristiGriffin', 'ColbieBlodgett', 'ColeCooper', 'ColeHalbasch',
                'ConnorDenney', 'CristianPerez', 'CruAnderson', 'DaltonCarter', 'DylanPenalozaDiaz', 'EleanorParson',
                'EllaLechtenberg', 'ElliotWhite', 'ElyseStephensen', 'EmmaThompson', 'EmmaTorres', 'EvieCompton',
                'FrancisAnwar', 'FrancisLeyva', 'GenevieveBriceno', 'GraceDavis', 'GrantChristensen', 'HadleyKelleher',
                'HalleGallacher', 'HannahHadean', 'HillaryWheeler', 'HunterHaskell', 'HunterTrevino', 'IsaacChiakis',
                'JacksonJohnson', 'JacksonWhitear', 'JainaKarakusis', 'JakeHeairld', 'JayceAbles', 'JaydenSmith',
                'JeffreyLeishman', 'JonathanChesnovar', 'JulieMartin', 'JustinBadham', 'KahvonFord', 'KaitlinStott',
                'KatelynChamberlain', 'KayleeVimahi', 'KaysonWallwork', 'Kenzie Bybee', 'KenzieBybee', 'KinisouElimo',
                'KiraAgamez', 'KiyrahMiller', 'LandonGraham', 'LandonUlrich', 'LanedanLee', 'LaurenArnesen', 'Liaison',
                'LillyVanwagoner', 'LincolnHoke', 'LucasKirby', 'LukeMontgomery', 'MackenzieMcclean',
                'MadelineCostello', 'MagnusWilson', 'MallieMartin', 'MargaretWalker', 'MarilynParker', 'MaryJaneBlack',
                'MayaHegoas', 'MeelaZendejas', 'MichelleCorrea', 'MilesWebster', 'MillieBeckstead', 'NadiaBurns',
                'NoahPalmer', 'NoraBarton', 'OliverPage', 'OliviaEvershed', 'PaulaSackett', 'PrestonPage',
                'RachelBallard', 'RachelScott', 'RyderReddig', 'RykerWeight', 'SamuelWilliam', 'SamuelWilliams',
                'SaraHill', 'SavannahWinegar', 'ShelbySteed', 'SpencerCostello', 'SuttonBuell', 'TalmageTingey',
                'TarelLewis', 'TaylorTroxel', 'TheodoreLloyd', 'TjGutierrez', 'TyGoddard', 'TylerAshby', 'TysonGraham',
                'WestonHemphill', 'WilliamHayes', 'WilliamJackson', 'WilliamMacKay', 'ZoeyFerguson', ]

taskType = ['braille', 'screenreader', 'abacus', 'iOS', 'magnifierSkills', 'Expanded Core Curriculum']
...
iOSSkills = ['Select and speak an item', 'Select the previous / next item', 'Move into / out of a group of items',
             'Select the first / last item on the screen', 'Speak the entire screen from the top',
             'Speak the entire screen from the selected item', 'Pause or continue speaking',
             'Speak additional information, such as the position within a list or whether text is selected',
             'Drag over the screen', 'Scroll up /down one page', 'Scroll left / right  one page',
             'Activate the selected item', 'Double-tap the selected item', 'Drag a slider',
             'Dismiss an alert or return to the previous screen', 'Edit an item label to make it easier to find',
             'Navigate forms', 'Help with current element', 'Toggle screen curtain on/off',
             'Split tap quick activation', 'Double-press button', 'Speak words/characters typed',
             'Access control center', 'Backspace', 'Write letters, numbers, punctation',
             'Change case, punctuation, numbers', 'Insert space', 'Choose a rotor setting', 'Change keyboard mode']
...
ECC_OrientationMobility = ['Body concepts: understanding body parts and function',
...
ECC_SelfDetermination = ['Self-knowledge: developing personal preferences, needs and desires',
...
ECC_CareerEducation = ['Career awareness: differentiating between work and play, understanding the value of work',
                       ...
                       'Listen and attend to others', 'Follow directions', 'Stay on task', 'Complete tasks',
                       'Play make believe and dress-up activities to imitate adult roles',
                       'Have responsibilities at home and school', 'Recognize different school & community workers',
                       ...
                       'Learn to work individually and in a group', 'Learn to be responsible for actions',
                       'Recognize that workers get paid', 'Develop good communication skills',
                       'Understand the rewards of work', 'Organize resources such as time and money',
                       ...
                       'Show interest in particular areas of work', 'Plan for life beyond high school']

abacusSkills = ['1.1. Setting Numbers', '1.2. Clearing Beads', '1.3. Place Value', '1.4. Vocabulary',
                '2.1. Addition of Single Digit Numbers', '2.2. Addition of Multiple Digit Numbers – Direct',
                '2.3. Addition of Multiple Digit Numbers – Indirect', '3.1 Subtraction',
                ...
                '5.2. Division – 2+ Digit Dividend AND 1 Digit Divisor ', '6.1. Addition of Decimals',
                '6.2. Subtraction of Decimals', '6.3. Multiplication of Decimals', '6.4. Division of Decimals',
                '7.1. Addition of Fractions', '7.2. Subtraction of Fractions', '7.3. Multiplication of Fractions',
                '7.4. Division of Fractions', '8.1. Percent', '8.2. Square Root']

screenreaderSkills = ['1.1. Turn on and off the screen reader', '1.2 Utilize modifier keys ', '1.3. Read text ',
                      '1.4. Identify the titles with headings',
                      '1.5. Access documents, open programs, navigate to desktop', '1.6 Switch program focus',
                      '2.1. Type with all keys', '2.2. Change screen reader settings', '2.3. Cursor Placement',
                      '2.4. Select, copy and paste text', '3.1. Define common element types',
                      '3.2. Identify each element by type.', '3.3 Navigate to the address bar',
                      '3.4. Method 1 - Navigate by Clickable Object', '3.5. Method 2 - Quick Keys',
                      '3.6. Method 3 - Elements Lists', '3.7. Justify Why they used a method', '3.8 Switch tab focus',
                      '3.9. Switch between screen reader modes', '3.10. Navigate a table',
                      '3.11. Develop a navigation sequence', '4.1. Save and open files', '4.2. Create and move folders',
                      '4.3. navigate a cloud-based file management system', '4.4. Download material from the internet',
                      '4.5. Extract zipped folders', '4.6. Utilize virtual cursors', '4.7. Use OCR']

brailleSkills = ['1.1. Track left to right', '1.2. Track top to bottom', '1.3. Discriminate shapes',
                 '1.4. Discriminate braille characters', '2.1. Mangold Progression: G C L',
                 '2.2. Mangold Progression: D Y', '2.3. Mangold Progression: A B', '2.4. Mangold Progression: S',
                 '2.5. Mangold Progression: W', '2.6. Mangold Progression: P O', '2.7. Mangold Progression: K',
                 '2.8. Mangold Progression: R', '2.9. Mangold Progression: M E', '2.10. Mangold Progression: H',
                 '2.11. Mangold Progression: N X', '2.12. Mangold Progression: Z F', '2.13. Mangold Progression: U T',
                 '2.14. Mangold Progression: Q I', '2.15. Mangold Progression: V J ', '3.1. Alphabetic Wordsigns',
                 '3.2. Braille Numbers', '3.3. Punctuation', '3.4. Strong Contractions (AND OF FOR WITH THE)',
                 '3.5. Strong Groupsigns (CH GH SH TH WH ED ER OU OW ST AR ING)',
                 '3.6. Strong Wordsigns (CH SH TH WH OU ST)', '3.7. Lower Groupsigns (BE CON DIS)',
                 '3.8. Lower Groupsigns (EA BB CC FF GG)', '3.9. Lower Groupsigns/Wordsigns (EN IN)',
                 '3.10. Lower Wordsigns (BE HIS WAS WERE)', '3.11. Dot 5 Contractions', '3.12. Dot 45 Contractions',
                 '3.13. Dot 456 Contractions', '3.14. Final Letter Groupsigns', '3.15. Shortform Words',
                 '4.1. Grade 1 Indicators', '4.2. Capitals Indicators', '4.3. Numeric Mode and Spatial math',
                 '4.4. Typeform Indicators (ITALIC, SCRIPT, UNDERLINE, BOLDFACE)', '5.1. Page Numbering',
                 '5.2. Headings', '5.3. Lists', '5.4. Poety / Drama', '6.1.  Operation and Comparison Signs',
                 '6.2. Grade 1 Mode', '6.3. Special Print Symbols', '6.4. Omission Marks', '6.5. Shape Indicators',
                 '6.6. Roman Numerals', '6.7. Fractions', '7.1. Grade 1 Mode and Algebra',
                 '7.2. Grade 1 Mode and Fractions', '7.3. Advanced Operation and Comparison Signs', '7.4. Indices',
                 '7.5. Roots and Radicals', '7.6. Miscellaneous Shape Indicators', '7.7. Functions',
                 '7.8. Greek letters', '8.1. Functions', '8.2. Modifiers, Bars, and Dots',
                 '8.3. Modifiers, Arrows, and Limits', '8.4. Probability', '8.5. Calculus: Differentiation',
                 '8.6. Calculus: Integration', '8.7. Vertical Bars']

cviDomains = ['colorPreference', 'needForMovement', 'visualLatency', 'visualFieldPreference', 'visualComplexity',
              'nonpurposefulGaze', 'distanceViewing', 'visualReflexes', 'visualNovelty', 'visuallyGuidedReach']
...
class dataPanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.studentname1 = wx.Choice(self, -1, choices=students, pos=(130, 50), size=(300, 30))
...
class braillePanel(scrolled.ScrolledPanel):
    def __init__(self, parent):
        ...
        wx.StaticText(self, -1, "Student Name", pos=(30, 50))
        self.studentname1 = wx.Choice(self, -1, choices=students, pos=(650, 50), size=(300, 30))
