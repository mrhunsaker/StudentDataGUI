# FILEPATH: /c:/Users/RYHUNSAKER/GitHubRepos/StudentDataGUI/tests/test_screenreader.py
...
from appPages.screenreader import save
...
class Testscreenreader(unittest.TestCase):
    def setUp(self):
        ...
        self.u_screenreader_trial11 = MagicMock()
        # ... repeat for all the other UI elements

    @patch('appPages.screenreader.datetime')
    @patch('appPages.screenreader.Path')
    @patch('appPages.screenreader.json')
    def test_save(self, mock_json, mock_path, mock_datetime):
        ...
        self.u_screenreader_trial11.value = 1
        # ... repeat for all the other UI elements
